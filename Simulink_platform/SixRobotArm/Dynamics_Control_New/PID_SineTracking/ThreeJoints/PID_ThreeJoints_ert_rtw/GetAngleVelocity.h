...
struct P_GetAngleSpeed_PID_ThreeJoin_T_ {
...
extern void PID_ThreeJoints_GetAngle_Init(B_GetAngle_PID_ThreeJoints_T *localB,
  P_GetAngle_PID_ThreeJoints_T *localP);
extern void PID_ThreeJoints_GetAngle(real_T *rty_Angle,
  B_GetAngle_PID_ThreeJoints_T *localB, P_GetAngle_PID_ThreeJoints_T *localP,
  uint16_T rtp_JJoint, real_T rtp_InitAngle);
extern void PID_ThreeJoi_GetAngleSpeed_Init(B_GetAngleSpeed_PID_ThreeJoin_T
  *localB, P_GetAngleSpeed_PID_ThreeJoin_T *localP);
extern void PID_ThreeJoints_GetAngleSpeed(real_T *rty_Velcity,
