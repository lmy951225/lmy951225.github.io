...
B_PID_ThreeJoints_T PID_ThreeJoints_B;

/* Block states (default storage) */
DW_PID_ThreeJoints_T PID_ThreeJoints_DW;

/* Real-time model */
RT_MODEL_PID_ThreeJoints_T PID_ThreeJoints_M_;
RT_MODEL_PID_ThreeJoints_T *const PID_ThreeJoints_M = &PID_ThreeJoints_M_;
...
void idle_num0_task_fcn(void)
{
  /* Call the system: <Root>/接收上位机的数据 */
  {
    ...
    /* Output and update for function-call system: '<Root>/接收上位机的数据' */
    {
       ...
       */
      if (PID_ThreeJoints_B.Switch[0] == PID_ThreeJoints_P.ux88_const) {
        /* SwitchCase: '<S171>/Switch Case' */
        switch ((int32_T)PID_ThreeJoints_B.Switch[1]) {
         case 1L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J1[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 2L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J2[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 3L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J3[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 4L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J4[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 5L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J5[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 6L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J6[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
         ...
         case 7L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J7[i] = (int16_T)PID_ThreeJoints_B.Switch[i + 2];
          }
       ...
       */
      StartRobot = (uint16_T)((PID_ThreeJoints_B.Switch[0] ==
        PID_ThreeJoints_P.ux0080_const) && PID_ThreeJoints_DW.PTX &&
        (PID_ThreeJoints_B.Switch[2] ==
         PID_ThreeJoints_P.CompareToConstant1_const) &&
        (PID_ThreeJoints_B.Switch[3] ==
         PID_ThreeJoints_P.CompareToConstant2_const));
    }
...
void PID_ThreeJoin_CANA_284_24_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive1_o2[0] */
  {
    PID_ThreeJoints_B.eCANReceive1_o2[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive1_o2[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANA_284_24(void)
{
  /* S-Function (c280xcanrcv): '<S151>/eCAN Receive1' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP24) {
      ...
      EDIS;
      PID_ThreeJoints_B.eCANReceive1_o2[0] = ECanaMboxes.MBOX24.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive1_o2[1] = ECanaMboxes.MBOX24.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive1_o2[2] = ECanaMboxes.MBOX24.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive1_o2[3] = ECanaMboxes.MBOX24.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive1_o2[4] = ECanaMboxes.MBOX24.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive1_o2[5] = ECanaMboxes.MBOX24.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive1_o2[6] = ECanaMboxes.MBOX24.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive1_o2[7] = ECanaMboxes.MBOX24.MDH.byte.BYTE4;
       ...
       *  Sum: '<S157>/Add1'
       */
      Motor_Velocity[3L] = ((int16_T)PID_ThreeJoints_B.eCANReceive1_o2[3] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive1_o2[2];
       ...
       *  Sum: '<S157>/Add'
       */
      Motor_Position[3L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive1_o2[5] <<
        8U) + PID_ThreeJoints_B.eCANReceive1_o2[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive1_o2[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive1_o2[7] << 24U);
       ...
       *  Sum: '<S157>/Add2'
       */
      Motor_Current[3L] = ((int16_T)PID_ThreeJoints_B.eCANReceive1_o2[1] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive1_o2[0];
    }
  }
...
void PID_ThreeJoin_CANA_285_25_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive_o2_o[0] */
  {
    PID_ThreeJoints_B.eCANReceive_o2_o[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_o[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANA_285_25(void)
{
  /* S-Function (c280xcanrcv): '<S152>/eCAN Receive' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP25) {
      ...
      ECanaRegs.CANRMP.all = ECanaShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      PID_ThreeJoints_B.eCANReceive_o2_o[0] = ECanaMboxes.MBOX25.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive_o2_o[1] = ECanaMboxes.MBOX25.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive_o2_o[2] = ECanaMboxes.MBOX25.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive_o2_o[3] = ECanaMboxes.MBOX25.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive_o2_o[4] = ECanaMboxes.MBOX25.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive_o2_o[5] = ECanaMboxes.MBOX25.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive_o2_o[6] = ECanaMboxes.MBOX25.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive_o2_o[7] = ECanaMboxes.MBOX25.MDH.byte.BYTE4;
       ...
       *  Sum: '<S158>/Add1'
       */
      Motor_Velocity[4L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_o[3] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_o[2];
       ...
       *  Sum: '<S158>/Add'
       */
      Motor_Position[4L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive_o2_o[5] <<
        8U) + PID_ThreeJoints_B.eCANReceive_o2_o[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_o[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_o[7] << 24U);
       ...
       *  Sum: '<S158>/Add2'
       */
      Motor_Current[4L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_o[1] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_o[0];
    }
  }
...
void PID_ThreeJoin_CANA_286_26_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive_o2_a[0] */
  {
    PID_ThreeJoints_B.eCANReceive_o2_a[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_a[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANA_286_26(void)
{
  /* S-Function (c280xcanrcv): '<S153>/eCAN Receive' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP26) {
      ...
      ECanaRegs.CANRMP.all = ECanaShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      PID_ThreeJoints_B.eCANReceive_o2_a[0] = ECanaMboxes.MBOX26.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive_o2_a[1] = ECanaMboxes.MBOX26.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive_o2_a[2] = ECanaMboxes.MBOX26.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive_o2_a[3] = ECanaMboxes.MBOX26.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive_o2_a[4] = ECanaMboxes.MBOX26.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive_o2_a[5] = ECanaMboxes.MBOX26.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive_o2_a[6] = ECanaMboxes.MBOX26.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive_o2_a[7] = ECanaMboxes.MBOX26.MDH.byte.BYTE4;
       ...
       *  Sum: '<S159>/Add1'
       */
      Motor_Velocity[5L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_a[3] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_a[2];
       ...
       *  Sum: '<S159>/Add'
       */
      Motor_Position[5L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive_o2_a[5] <<
        8U) + PID_ThreeJoints_B.eCANReceive_o2_a[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_a[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_a[7] << 24U);
       ...
       *  Sum: '<S159>/Add2'
       */
      Motor_Current[5L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_a[1] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_a[0];
    }
  }
...
void PID_ThreeJoin_CANB_281_21_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive_o2_cc[0] */
  {
    PID_ThreeJoints_B.eCANReceive_o2_cc[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_cc[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANB_281_21(void)
{
  /* S-Function (c280xcanrcv): '<S154>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP21) {
      ...
      EDIS;
      PID_ThreeJoints_B.eCANReceive_o2_cc[0] = ECanbMboxes.MBOX21.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive_o2_cc[1] = ECanbMboxes.MBOX21.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive_o2_cc[2] = ECanbMboxes.MBOX21.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive_o2_cc[3] = ECanbMboxes.MBOX21.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive_o2_cc[4] = ECanbMboxes.MBOX21.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive_o2_cc[5] = ECanbMboxes.MBOX21.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive_o2_cc[6] = ECanbMboxes.MBOX21.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive_o2_cc[7] = ECanbMboxes.MBOX21.MDH.byte.BYTE4;
       ...
       *  Sum: '<S160>/Add1'
       */
      Motor_Velocity[0L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_cc[3] <<
                            8U) + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_cc[2];
       ...
       *  Sum: '<S160>/Add'
       */
      Motor_Position[0L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive_o2_cc[5] <<
        8U) + PID_ThreeJoints_B.eCANReceive_o2_cc[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_cc[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_cc[7] << 24U);
       ...
       *  Sum: '<S160>/Add2'
       */
      Motor_Current[0L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_cc[1] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_cc[0];
    }
  }
...
void PID_ThreeJoin_CANB_282_22_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive_o2_c[0] */
  {
    PID_ThreeJoints_B.eCANReceive_o2_c[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2_c[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANB_282_22(void)
{
  /* S-Function (c280xcanrcv): '<S155>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP22) {
      ...
      ECanbRegs.CANRMP.all = ECanbShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      PID_ThreeJoints_B.eCANReceive_o2_c[0] = ECanbMboxes.MBOX22.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive_o2_c[1] = ECanbMboxes.MBOX22.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive_o2_c[2] = ECanbMboxes.MBOX22.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive_o2_c[3] = ECanbMboxes.MBOX22.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive_o2_c[4] = ECanbMboxes.MBOX22.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive_o2_c[5] = ECanbMboxes.MBOX22.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive_o2_c[6] = ECanbMboxes.MBOX22.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive_o2_c[7] = ECanbMboxes.MBOX22.MDH.byte.BYTE4;
       ...
       *  Sum: '<S161>/Add1'
       */
      Motor_Velocity[1L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2_c[3] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2_c[2];
       ...
       *  Sum: '<S161>/Add'
       */
      Motor_Position[1L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive_o2_c[5] <<
        8U) + PID_ThreeJoints_B.eCANReceive_o2_c[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_c[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2_c[7] << 24U);
       ...
       *  Sum: '<S161>/Add2'
       */
      Motor_Current[1L] = ((int32_T)PID_ThreeJoints_B.eCANReceive_o2_c[1] << 8U)
        + PID_ThreeJoints_B.eCANReceive_o2_c[0];
    }
  }
...
void PID_ThreeJoin_CANB_283_23_Start(void)
{
  ...
  /* Initialize PID_ThreeJoints_B.eCANReceive_o2[0] */
  {
    PID_ThreeJoints_B.eCANReceive_o2[0] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[1] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[2] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[3] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[4] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[5] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[6] = (uint8_T)0.0;
    PID_ThreeJoints_B.eCANReceive_o2[7] = (uint8_T)0.0;
  }
...
void PID_ThreeJoints_CANB_283_23(void)
{
  /* S-Function (c280xcanrcv): '<S156>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP23) {
      ...
      ECanbRegs.CANRMP.all = ECanbShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      PID_ThreeJoints_B.eCANReceive_o2[0] = ECanbMboxes.MBOX23.MDL.byte.BYTE3;
      PID_ThreeJoints_B.eCANReceive_o2[1] = ECanbMboxes.MBOX23.MDL.byte.BYTE2;
      PID_ThreeJoints_B.eCANReceive_o2[2] = ECanbMboxes.MBOX23.MDL.byte.BYTE1;
      PID_ThreeJoints_B.eCANReceive_o2[3] = ECanbMboxes.MBOX23.MDL.byte.BYTE0;
      PID_ThreeJoints_B.eCANReceive_o2[4] = ECanbMboxes.MBOX23.MDH.byte.BYTE7;
      PID_ThreeJoints_B.eCANReceive_o2[5] = ECanbMboxes.MBOX23.MDH.byte.BYTE6;
      PID_ThreeJoints_B.eCANReceive_o2[6] = ECanbMboxes.MBOX23.MDH.byte.BYTE5;
      PID_ThreeJoints_B.eCANReceive_o2[7] = ECanbMboxes.MBOX23.MDH.byte.BYTE4;
       ...
       *  Sum: '<S162>/Add1'
       */
      Motor_Velocity[2L] = ((int16_T)PID_ThreeJoints_B.eCANReceive_o2[3] << 8U)
        + (int16_T)PID_ThreeJoints_B.eCANReceive_o2[2];
       ...
       *  Sum: '<S162>/Add'
       */
      Motor_Position[2L] = ((((int32_T)PID_ThreeJoints_B.eCANReceive_o2[5] << 8U)
        + PID_ThreeJoints_B.eCANReceive_o2[4]) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2[6] << 16U)) + ((int32_T)
        PID_ThreeJoints_B.eCANReceive_o2[7] << 24U);
       ...
       *  Sum: '<S162>/Add2'
       */
      Motor_Current[2L] = ((int32_T)PID_ThreeJoints_B.eCANReceive_o2[1] << 8U) +
        PID_ThreeJoints_B.eCANReceive_o2[0];
    }
  }
...
void PID_ThreeJoints_u_k(void)
{
  ...
  /* S-Function (c28xsci_rx): '<S172>/ ' */
  {
    ...
    if (errFlg != NOERROR)
      goto RXERRA;
    memcpy( &PID_ThreeJoints_B._o1[0], recbuff, 9);
   RXERRA:
    asm(" NOP");
    PID_ThreeJoints_B._o2 = errFlg;
  }

  /* RelationalOperator: '<S180>/Relational Operator' incorporates:
   *  Sum: '<S180>/Add'
   */
  rtb_RelationalOperator = (((((((PID_ThreeJoints_B._o1[0] +
    PID_ThreeJoints_B._o1[1]) + PID_ThreeJoints_B._o1[2]) +
    PID_ThreeJoints_B._o1[3]) + PID_ThreeJoints_B._o1[4]) +
    PID_ThreeJoints_B._o1[5]) + PID_ThreeJoints_B._o1[6]) +
    PID_ThreeJoints_B._o1[7] == PID_ThreeJoints_B._o1[8]);
  ...
  for (i = 0; i < 9; i++) {
    if (rtb_RelationalOperator) {
      PID_ThreeJoints_B.Switch[i] = PID_ThreeJoints_B._o1[i];
    } else {
      PID_ThreeJoints_B.Switch[i] = PID_ThreeJoints_P.Constant_Value_mw[i];
    }
  }
   ...
   */
  if (PID_ThreeJoints_B._o2 > PID_ThreeJoints_P.Switch_Threshold_a) {
    tmp = PID_ThreeJoints_P.Constant_Value_e;
  } else {
    tmp = PID_ThreeJoints_P.Constant1_Value_p;
  }
   ...
   */
  PID_ThreeJoints_DW.PTX = (rtb_RelationalOperator && tmp);
}

/* System initialize for atomic system: '<Root>/SendDataToGUI' */
void PID_ThreeJoi_SendDataToGUI_Init(void)
{
  /* InitializeConditions for UnitDelay: '<S164>/Output' */
  PID_ThreeJoints_DW.Output_DSTATE = PID_ThreeJoints_P.Output_InitialCondition;
}

/* Output and update for atomic system: '<Root>/SendDataToGUI' */
void PID_ThreeJoints_SendDataToGUI(void)
{
  uint16_T rtb_DataTypeConversion12[18];
  int16_T i;
  uint16_T rtb_DataTypeConversion12_l;
  real_T tmp;
  boolean_T tmp_0;
   ...
   */
  if (PID_ThreeJoints_DW.Output_DSTATE > PID_ThreeJoints_P.Switch_Threshold_h) {
    tmp_0 = PID_ThreeJoints_P.Constant1_Value_o;
  } else {
    tmp_0 = PID_ThreeJoints_P.Constant_Value_n;
  }
  ...
  if (tmp_0) {
     ...
     */
    PID_ThreeJoints_B.TmpSignalConversionAtSCITransmi[0] =
      PID_ThreeJoints_P.Constant1_Value_d;
    for (i = 0; i < 18; i++) {
      ...
      rtb_DataTypeConversion12_l = tmp < 0.0 ? (uint16_T)-(int16_T)(uint16_T)
        -tmp : (uint16_T)tmp;

      /* SignalConversion: '<S163>/TmpSignal ConversionAtSCI TransmitInport1' */
      PID_ThreeJoints_B.TmpSignalConversionAtSCITransmi[i + 1] =
        rtb_DataTypeConversion12_l;

      /* DataTypeConversion: '<S163>/Data Type Conversion12' */
      rtb_DataTypeConversion12[i] = rtb_DataTypeConversion12_l;
    }
     ...
     *  Sum: '<S163>/校验码填充'
     */
    PID_ThreeJoints_B.TmpSignalConversionAtSCITransmi[19] =
      (((((((((((((((((PID_ThreeJoints_P.Constant1_Value_d +
    ...
    {
      scia_xmit((char*)&PID_ThreeJoints_B.TmpSignalConversionAtSCITransmi[0], 40,
                2);
    }
  }
   ...
   *  UnitDelay: '<S164>/Output'
   */
  PID_ThreeJoints_DW.Output_DSTATE = (PID_ThreeJoints_DW.Output_DSTATE +
    PID_ThreeJoints_P.FixPtConstant_Value) & 255U;

  /* Switch: '<S166>/FixPt Switch' incorporates:
   *  Constant: '<S166>/Constant'
   *  UnitDelay: '<S164>/Output'
   */
  if (PID_ThreeJoints_DW.Output_DSTATE > PID_ThreeJoints_P._uplimit) {
    PID_ThreeJoints_DW.Output_DSTATE = PID_ThreeJoints_P.Constant_Value_p;
  }
...
/* Model step function */
void PID_ThreeJoints_step(void)
{
  /* Outputs for Atomic SubSystem: '<Root>/GetMotorData' */
  PID_ThreeJoints_GetMotorData();
  ...
  PID_ThreeJoints_SendDataToGUI();

  /* End of Outputs for SubSystem: '<Root>/SendDataToGUI' */
}

/* Model initialize function */
void PID_ThreeJoints_initialize(void)
{
  /* Registration code */
  ...
  rtmSetErrorStatus(PID_ThreeJoints_M, (NULL));

  /* block I/O */
  (void) memset(((void *) &PID_ThreeJoints_B), 0,
                sizeof(B_PID_ThreeJoints_T));

  /* states (dwork) */
  (void) memset((void *)&PID_ThreeJoints_DW, 0,
                sizeof(DW_PID_ThreeJoints_T));
...

  {
    ...
    PID_ThreeJoi_GetMotorData_Start();
    ...
    PID_ThreeJoints_u_o_Start();

    /* End of Start for SubSystem: '<S5>/获取用户命令' */

    /* Start for DataStoreMemory: '<S5>/消息使能' */
    PID_ThreeJoints_DW.PTX = PID_ThreeJoints_P._InitialValue_g;
    for (i = 0; i < 6; i++) {
      /* Start for DataStoreMemory: '<Root>/Data Store Memory1' */
      Motor_Position[i] = PID_ThreeJoints_P.DataStoreMemory1_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory10' */
      J7[i] = PID_ThreeJoints_P.DataStoreMemory10_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory11' */
      Motor_Current[i] = PID_ThreeJoints_P.DataStoreMemory11_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory13' */
      J1[i] = PID_ThreeJoints_P.DataStoreMemory13_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory2' */
      Motor_Velocity[i] = PID_ThreeJoints_P.DataStoreMemory2_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory3' */
      J2[i] = PID_ThreeJoints_P.DataStoreMemory3_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory4' */
      J3[i] = PID_ThreeJoints_P.DataStoreMemory4_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory5' */
      J4[i] = PID_ThreeJoints_P.DataStoreMemory5_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory6' */
      J5[i] = PID_ThreeJoints_P.DataStoreMemory6_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory7' */
      J6[i] = PID_ThreeJoints_P.DataStoreMemory7_InitialValue[i];
    }

    /* Start for DataStoreMemory: '<Root>/Data Store Memory8' */
    memcpy(&Send_GUIdata[0], &PID_ThreeJoints_P.DataStoreMemory8_InitialValue[0],
           18U * sizeof(real_T));

    /* Start for DataStoreMemory: '<Root>/Data Store Memory9' */
    StartRobot = PID_ThreeJoints_P.DataStoreMemory9_InitialValue;
    ...
    PID_ThreeJoi_SendDataToGUI_Init();
...
void PID_ThreeJoints_terminate(void)
{
