...
} B_GetAngle_PID_MoreJoints1_6_T;

/* Block signals for system '<S8>/GetAngleSpeed' */
typedef struct {
  int32_T Merge1;                      /* '<S55>/Merge1' */
} B_GetAngleSpeed_PID_MoreJoint_T;

/* Parameters for system: '<S8>/GetAngle' */
struct P_GetAngle_PID_MoreJoints1_6_T_ {
...
struct P_GetAngleSpeed_PID_MoreJoint_T_ {
...
extern void PID_MoreJoints1_6_GetAngle_Init(B_GetAngle_PID_MoreJoints1_6_T
  *localB, P_GetAngle_PID_MoreJoints1_6_T *localP);
extern void PID_MoreJoints1_6_GetAngle(real_T *rty_Angle,
  B_GetAngle_PID_MoreJoints1_6_T *localB, P_GetAngle_PID_MoreJoints1_6_T *localP,
  uint16_T rtp_JJoint, real_T rtp_InitAngle);
extern void PID_MoreJoin_GetAngleSpeed_Init(B_GetAngleSpeed_PID_MoreJoint_T
  *localB, P_GetAngleSpeed_PID_MoreJoint_T *localP);
extern void PID_MoreJoints1_6_GetAngleSpeed(real_T *rty_Velcity,
