 ...
 *    '<S8>/GetAngle5'
 */
void PID_MoreJoints1_6_GetAngle_Init(B_GetAngle_PID_MoreJoints1_6_T *localB,
  P_GetAngle_PID_MoreJoints1_6_T *localP)
{
 ...
 *    '<S8>/GetAngle5'
 */
void PID_MoreJoints1_6_GetAngle(real_T *rty_Angle,
  B_GetAngle_PID_MoreJoints1_6_T *localB, P_GetAngle_PID_MoreJoints1_6_T *localP,
 ...
 *    '<S8>/GetAngleSpeed5'
 */
void PID_MoreJoin_GetAngleSpeed_Init(B_GetAngleSpeed_PID_MoreJoint_T *localB,
  P_GetAngleSpeed_PID_MoreJoint_T *localP)
{
 ...
 *    '<S8>/GetAngleSpeed5'
 */
void PID_MoreJoints1_6_GetAngleSpeed(real_T *rty_Velcity,
  B_GetAngleSpeed_PID_MoreJoint_T *localB, P_GetAngleSpeed_PID_MoreJoint_T
...
void GetAngleVelocity(void)
{
  ...
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.Sum1_g,
    &PID_MoreJoints1_6_B.GetAngleSpeed, &PID_MoreJoints1_6_P.GetAngleSpeed,
    PID_MoreJoints1_6_P.GetAngleSpeed_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed1' */
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.Sum1_c,
    &PID_MoreJoints1_6_B.GetAngleSpeed1, &PID_MoreJoints1_6_P.GetAngleSpeed1,
    PID_MoreJoints1_6_P.GetAngleSpeed1_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed2' */
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.Sum1_o,
    &PID_MoreJoints1_6_B.GetAngleSpeed2, &PID_MoreJoints1_6_P.GetAngleSpeed2,
    PID_MoreJoints1_6_P.GetAngleSpeed2_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed3' */
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.Sum1_ge,
    &PID_MoreJoints1_6_B.GetAngleSpeed3, &PID_MoreJoints1_6_P.GetAngleSpeed3,
    PID_MoreJoints1_6_P.GetAngleSpeed3_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed4' */
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.u,
    &PID_MoreJoints1_6_B.GetAngleSpeed4, &PID_MoreJoints1_6_P.GetAngleSpeed4,
    PID_MoreJoints1_6_P.GetAngleSpeed4_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed5' */
  PID_MoreJoints1_6_GetAngleSpeed(&PID_MoreJoints1_6_B.Saturation6,
    &PID_MoreJoints1_6_B.GetAngleSpeed5, &PID_MoreJoints1_6_P.GetAngleSpeed5,
    PID_MoreJoints1_6_P.GetAngleSpeed5_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed5' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Saturation2,
    &PID_MoreJoints1_6_B.GetAngle, &PID_MoreJoints1_6_P.GetAngle,
    PID_MoreJoints1_6_P.GetAngle_JJoint, PID_MoreJoints1_6_P.GetAngle_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle1' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Saturation1,
    &PID_MoreJoints1_6_B.GetAngle1, &PID_MoreJoints1_6_P.GetAngle1,
    PID_MoreJoints1_6_P.GetAngle1_JJoint,
    PID_MoreJoints1_6_P.GetAngle1_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle2' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Saturation3,
    &PID_MoreJoints1_6_B.GetAngle2, &PID_MoreJoints1_6_P.GetAngle2,
    PID_MoreJoints1_6_P.GetAngle2_JJoint,
    PID_MoreJoints1_6_P.GetAngle2_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle3' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Saturation4,
    &PID_MoreJoints1_6_B.GetAngle3, &PID_MoreJoints1_6_P.GetAngle3,
    PID_MoreJoints1_6_P.GetAngle3_JJoint,
    PID_MoreJoints1_6_P.GetAngle3_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle4' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Saturation5,
    &PID_MoreJoints1_6_B.GetAngle4, &PID_MoreJoints1_6_P.GetAngle4,
    PID_MoreJoints1_6_P.GetAngle4_JJoint,
    PID_MoreJoints1_6_P.GetAngle4_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle5' */
  PID_MoreJoints1_6_GetAngle(&PID_MoreJoints1_6_B.Sum1,
    &PID_MoreJoints1_6_B.GetAngle5, &PID_MoreJoints1_6_P.GetAngle5,
    PID_MoreJoints1_6_P.GetAngle5_JJoint,
    PID_MoreJoints1_6_P.GetAngle5_InitAngle);
