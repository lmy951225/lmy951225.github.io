...
void DynamicsController_Init(void)
{
  ...
  SineSignal_Init(&PID_MoreJoints1_6_B.Product_e, &PID_MoreJoints1_6_B.Sum5_i,
                  &PID_MoreJoints1_6_DW.u_l, &PID_MoreJoints1_6_P.u_l);

  /* End of SystemInitialize for SubSystem: '<S1>/关节一正弦信号发生器' */

  /* SystemInitialize for Atomic SubSystem: '<S1>/关节二正弦信号发生器' */
  SineSignal_Init(&PID_MoreJoints1_6_B.Product_d, &PID_MoreJoints1_6_B.Sum5_g,
                  &PID_MoreJoints1_6_DW.u_j, &PID_MoreJoints1_6_P.u_j);

  /* End of SystemInitialize for SubSystem: '<S1>/关节二正弦信号发生器' */

  /* SystemInitialize for Atomic SubSystem: '<S1>/关节三正弦信号发生器' */
  SineSignal_Init(&PID_MoreJoints1_6_B.Product_a, &PID_MoreJoints1_6_B.Sum5_l,
                  &PID_MoreJoints1_6_DW.u_a, &PID_MoreJoints1_6_P.u_a);

  /* End of SystemInitialize for SubSystem: '<S1>/关节三正弦信号发生器' */

  /* SystemInitialize for Atomic SubSystem: '<S1>/关节四正弦信号发生器' */
  SineSignal_Init(&PID_MoreJoints1_6_B.Product, &PID_MoreJoints1_6_B.Sum5,
                  &PID_MoreJoints1_6_DW.u_e, &PID_MoreJoints1_6_P.u_e);

  /* End of SystemInitialize for SubSystem: '<S1>/关节四正弦信号发生器' */

  /* SystemInitialize for Atomic SubSystem: '<S1>/关节五正弦信号发生器' */
  SineSignal_Init(&PID_MoreJoints1_6_B.Product_b, &PID_MoreJoints1_6_B.Sum5_ak,
                  &PID_MoreJoints1_6_DW.u_d, &PID_MoreJoints1_6_P.u_d);

  /* End of SystemInitialize for SubSystem: '<S1>/关节五正弦信号发生器' */

  /* SystemInitialize for Atomic SubSystem: '<S1>/关节六正弦信号发生器' */
  SineSignal_Init(&PID_MoreJoints1_6_B.Product_k, &PID_MoreJoints1_6_B.Sum5_a,
                  &PID_MoreJoints1_6_DW.u_k, &PID_MoreJoints1_6_P.u_k);
...
void DynamicsController_Start(void)
{
  ...
  for (i = 0; i < 6; i++) {
    ...
    qd[i] = PID_MoreJoints1_6_P._InitialValue[i];

    /* Start for DataStoreMemory: '<S1>/各个关节内转子采集 到的实际角度' */
    q[i] = PID_MoreJoints1_6_P._InitialValue_h[i];

    /* Start for DataStoreMemory: '<S1>/各个关节内转子采集 到的实际角速度' */
    dq[i] = PID_MoreJoints1_6_P._InitialValue_m[i];

    /* Start for DataStoreMemory: '<S1>/各个关节的内转子 位置跟踪误差' */
    e[i] = PID_MoreJoints1_6_P._InitialValue_hw[i];
  }

  /* Start for DataStoreMemory: '<S1>/驱动各个关节 运动的力矩' */
  for (i = 0; i < 12; i++) {
    Tau[i] = PID_MoreJoints1_6_P._InitialValue_j[i];
  }
...
void DynamicsController(void)
{
  ...
  q[0] = PID_MoreJoints1_6_B.Saturation2;
  q[1] = PID_MoreJoints1_6_B.Saturation1;
  q[2] = PID_MoreJoints1_6_B.Saturation3;
  q[3] = PID_MoreJoints1_6_B.Saturation4;
  q[4] = PID_MoreJoints1_6_B.Saturation5;
  q[5] = PID_MoreJoints1_6_B.Sum1;

  /* DataStoreWrite: '<S1>/各关节角速度' */
  dq[0] = PID_MoreJoints1_6_B.Sum1_g;
  dq[1] = PID_MoreJoints1_6_B.Sum1_c;
  dq[2] = PID_MoreJoints1_6_B.Sum1_o;
  dq[3] = PID_MoreJoints1_6_B.Sum1_ge;
  dq[4] = PID_MoreJoints1_6_B.u;
  dq[5] = PID_MoreJoints1_6_B.Saturation6;

  /* Outputs for Atomic SubSystem: '<S1>/关节一正弦信号发生器' */
  /* DataStoreRead: '<S1>/使能信号1' incorporates:
   *  DataStoreRead: '<S1>/q1'
   */
  SineSignal(J6[0], q[0], &PID_MoreJoints1_6_B.Product_e,
             &PID_MoreJoints1_6_B.Sum5_i, &PID_MoreJoints1_6_DW.u_l,
             &PID_MoreJoints1_6_P.u_l);
   ...
   *  DataStoreRead: '<S1>/q2'
   */
  SineSignal(J6[0], q[1], &PID_MoreJoints1_6_B.Product_d,
             &PID_MoreJoints1_6_B.Sum5_g, &PID_MoreJoints1_6_DW.u_j,
             &PID_MoreJoints1_6_P.u_j);
   ...
   *  DataStoreRead: '<S1>/q3'
   */
  SineSignal(J6[0], q[2], &PID_MoreJoints1_6_B.Product_a,
             &PID_MoreJoints1_6_B.Sum5_l, &PID_MoreJoints1_6_DW.u_a,
             &PID_MoreJoints1_6_P.u_a);
   ...
   *  DataStoreRead: '<S1>/q4'
   */
  SineSignal(J6[0], q[3], &PID_MoreJoints1_6_B.Product,
             &PID_MoreJoints1_6_B.Sum5, &PID_MoreJoints1_6_DW.u_e,
             &PID_MoreJoints1_6_P.u_e);
   ...
   *  DataStoreRead: '<S1>/q5'
   */
  SineSignal(J6[0], q[4], &PID_MoreJoints1_6_B.Product_b,
             &PID_MoreJoints1_6_B.Sum5_ak, &PID_MoreJoints1_6_DW.u_d,
             &PID_MoreJoints1_6_P.u_d);
   ...
   *  DataStoreRead: '<S1>/q6'
   */
  SineSignal(J6[0], q[5], &PID_MoreJoints1_6_B.Product_k,
             &PID_MoreJoints1_6_B.Sum5_a, &PID_MoreJoints1_6_DW.u_k,
             &PID_MoreJoints1_6_P.u_k);

  /* End of Outputs for SubSystem: '<S1>/关节六正弦信号发生器' */

  /* DataStoreWrite: '<S1>/Data Store Write7' */
  e[0L] = PID_MoreJoints1_6_B.Sum5_i;

  /* DataStoreWrite: '<S1>/Data Store Write8' */
  e[1L] = PID_MoreJoints1_6_B.Sum5_g;

  /* DataStoreWrite: '<S1>/Data Store Write10' */
  e[2L] = PID_MoreJoints1_6_B.Sum5_l;

  /* DataStoreWrite: '<S1>/Data Store Write12' */
  e[3L] = PID_MoreJoints1_6_B.Sum5;

  /* DataStoreWrite: '<S1>/Data Store Write14' */
  e[4L] = PID_MoreJoints1_6_B.Sum5_ak;

  /* DataStoreWrite: '<S1>/Data Store Write16' */
  e[5L] = PID_MoreJoints1_6_B.Sum5_a;

  /* DataStoreRead: '<S1>/e' */
  PID_MoreJoints1_6_B.Sum1 = e[0];
  PID_MoreJoints1_6_B.Sum1_g = e[1];
  PID_MoreJoints1_6_B.Sum1_c = e[2];
  PID_MoreJoints1_6_B.Sum1_o = e[3];
  PID_MoreJoints1_6_B.Sum1_ge = e[4];
  PID_MoreJoints1_6_B.u = e[5];
  ...
  Tau[0] = PID_MoreJoints1_6_B.Saturation6;
  Tau[1] = PID_MoreJoints1_6_B.Sum1;
  Tau[2] = PID_MoreJoints1_6_B.Sum1_g;
  Tau[3] = PID_MoreJoints1_6_B.Sum1_c;
  Tau[4] = PID_MoreJoints1_6_B.Sum1_o;
  Tau[5] = PID_MoreJoints1_6_B.Sum1_ge;

  /* DataStoreWrite: '<S1>/Data Store Write4' */
  Tau[6] = PID_MoreJoints1_6_B.Saturation5;
  Tau[7] = PID_MoreJoints1_6_B.Saturation2;
  Tau[8] = PID_MoreJoints1_6_B.Saturation3;
  Tau[9] = PID_MoreJoints1_6_B.Saturation1;
  Tau[10] = PID_MoreJoints1_6_B.Saturation4;
  Tau[11] = PID_MoreJoints1_6_B.u;
  for (i = 0; i < 6; i++) {
    /* Sum: '<S1>/Add' incorporates:
     *  DataStoreRead: '<S1>/Tau1~6_1'
     *  DataStoreRead: '<S1>/Tau1~6_2'
     */
    PID_MoreJoints1_6_B.Add[i] = Tau[6 + i] + Tau[i];

    /* DataStoreWrite: '<S1>/上位机监控窗口1~6——参数3' */
    Send_GUIdata[(int32_T)(i + 12)] = PID_MoreJoints1_6_B.Add[i];
  }
   ...
   */
  for (i = 0; i < 6; i++) {
    Send_GUIdata[(int32_T)i] = PID_MoreJoints1_6_P.Gain5_Gain_l * q[i] *
      PID_MoreJoints1_6_P.Gain7_Gain;
  }
   ...
   */
  for (i = 0; i < 6; i++) {
    Send_GUIdata[(int32_T)(i + 6)] = PID_MoreJoints1_6_P.Gain6_Gain * e[i] *
      PID_MoreJoints1_6_P.Gain8_Gain;
  }

  /* End of DataStoreWrite: '<S1>/上位机监控窗口1~6——参数2' */

  /* DataStoreRead: '<S1>/切换到电流模式 的使能信号' */
  PID_MoreJoints1_6_B.u = J7[0];
  ...
  qd[0L] = PID_MoreJoints1_6_B.Product_e;

  /* DataStoreWrite: '<S1>/Data Store Write9' */
  qd[1L] = PID_MoreJoints1_6_B.Product_d;

  /* DataStoreWrite: '<S1>/Data Store Write11' */
  qd[2L] = PID_MoreJoints1_6_B.Product_a;

  /* DataStoreWrite: '<S1>/Data Store Write13' */
  qd[3L] = PID_MoreJoints1_6_B.Product;

  /* DataStoreWrite: '<S1>/Data Store Write15' */
  qd[4L] = PID_MoreJoints1_6_B.Product_b;

  /* DataStoreWrite: '<S1>/Data Store Write17' */
  qd[5L] = PID_MoreJoints1_6_B.Product_k;
}
