...
} DW_Subsystem_PID_DoubleJoints_T;

/* Block states (default storage) for system '<S1>/关节一正弦信号发生器' */
typedef struct {
  DW_Subsystem_PID_DoubleJoints_T Subsystem;/* '<S10>/Subsystem' */
} DW_SineSignal_T;

/* Parameters for system: '<S10>/Subsystem' */
struct P_Subsystem_PID_DoubleJoints_T_ {
...
struct P_SineSignal_T_ {
  ...
  real_T Gain14_Gain;                  /* Expression: pi/180
                                        ...
                                        */
  P_Subsystem_PID_DoubleJoints_T Subsystem;/* '<S10>/Subsystem' */
};

extern void PID_DoubleJoints_Subsystem_Init(real_T *rty_u, real_T *rty_u_c,
  DW_Subsystem_PID_DoubleJoints_T *localDW, P_Subsystem_PID_DoubleJoints_T
  *localP);
extern void PID_DoubleJoint_Subsystem_Start(DW_Subsystem_PID_DoubleJoints_T
  *localDW, P_Subsystem_PID_DoubleJoints_T *localP);
extern void PID_DoubleJoints_Subsystem(real_T rtu_Enable, real_T rtu_rad, real_T
  rtu_u, real_T *rty_u, real_T *rty_u_c, DW_Subsystem_PID_DoubleJoints_T
  *localDW, P_Subsystem_PID_DoubleJoints_T *localP, real_T rtp_Freq);
