...
#ifndef RTW_HEADER_PID_DoubleJoints_h_
#define RTW_HEADER_PID_DoubleJoints_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
...
typedef struct {
  ...
  uint16_T StartRobot_h;               /* '<S17>/Chart2' */
  uint16_T In1;                        /* '<S48>/In1' */
  uint16_T DataTypeConversion[8];      /* '<S47>/Data Type Conversion' */
  uint16_T DataTypeConversion_k[8];    /* '<S46>/Data Type Conversion' */
  uint16_T DataTypeConversion_o[8];    /* '<S45>/Data Type Conversion' */
  uint16_T DataTypeConversion_b[8];    /* '<S44>/Data Type Conversion' */
  uint16_T DataTypeConversion_l[8];    /* '<S43>/Data Type Conversion' */
  uint16_T DataTypeConversion_h[8];    /* '<S42>/Data Type Conversion' */
  uint16_T TmpSignalConversionAtSCITransmi[20];
  uint16_T eCANReceive_o2[8];          /* '<S156>/eCAN Receive' */
  uint16_T eCANReceive_o2_o[8];        /* '<S155>/eCAN Receive' */
  uint16_T eCANReceive_o2_k[8];        /* '<S154>/eCAN Receive' */
  uint16_T eCANReceive_o2_a[8];        /* '<S153>/eCAN Receive' */
  uint16_T eCANReceive_o2_k5[8];       /* '<S152>/eCAN Receive' */
  uint16_T eCANReceive1_o2[8];         /* '<S151>/eCAN Receive1' */
  uint16_T DataTypeConversion12[48];   /* '<S17>/Data Type Conversion12' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed5;/* '<S8>/GetAngleSpeed5' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed4;/* '<S8>/GetAngleSpeed4' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed3;/* '<S8>/GetAngleSpeed3' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed2;/* '<S8>/GetAngleSpeed2' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed1;/* '<S8>/GetAngleSpeed1' */
  B_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed;/* '<S8>/GetAngleSpeed' */
  B_GetAngle_PID_DoubleJoints_T GetAngle5;/* '<S8>/GetAngle5' */
  B_GetAngle_PID_DoubleJoints_T GetAngle4;/* '<S8>/GetAngle4' */
  B_GetAngle_PID_DoubleJoints_T GetAngle3;/* '<S8>/GetAngle3' */
  B_GetAngle_PID_DoubleJoints_T GetAngle2;/* '<S8>/GetAngle2' */
  B_GetAngle_PID_DoubleJoints_T GetAngle1;/* '<S8>/GetAngle1' */
  B_GetAngle_PID_DoubleJoints_T GetAngle;/* '<S8>/GetAngle' */
} B_PID_DoubleJoints_T;
...
typedef struct {
  ...
  uint16_T is_active_c5_PID_DoubleJoints;/* '<S17>/Chart2' */
  uint16_T is_c5_PID_DoubleJoints;     /* '<S17>/Chart2' */
  ...
  DW_PID_Controller1_PID_Double_T PID_Controller6;/* '<S9>/PID_Controller6' */
  DW_PID_Controller1_PID_Double_T PID_Controller5;/* '<S9>/PID_Controller5' */
  DW_PID_Controller1_PID_Double_T PID_Controller4;/* '<S9>/PID_Controller4' */
  DW_PID_Controller1_PID_Double_T PID_Controller3;/* '<S9>/PID_Controller3' */
  DW_PID_Controller1_PID_Double_T PID_Controller2;/* '<S9>/PID_Controller2' */
  DW_PID_Controller1_PID_Double_T PID_Controller1;/* '<S9>/PID_Controller1' */
} DW_PID_DoubleJoints_T;

/* Parameters (default storage) */
struct P_PID_DoubleJoints_T_ {
  ...
  uint16_T MSG_Y0_e;                   /* Computed Parameter: MSG_Y0_e
                                        ...
                                        */
  uint16_T MSG_Y0_b;                   /* Computed Parameter: MSG_Y0_b
  ...
  uint16_T Constant_Value_n;           /* Computed Parameter: Constant_Value_n
                                        ...
                                        */
  uint16_T Constant1_Value_pe;         /* Computed Parameter: Constant1_Value_pe
  ...
  uint16_T Constant3_Value_a;          /* Computed Parameter: Constant3_Value_a
                                        ...
                                        */
  uint16_T Constant8_Value_j;          /* Computed Parameter: Constant8_Value_j
                                        * Referenced by: '<S44>/Constant8'
                                        */
  uint16_T Constant1_Value_aw;         /* Computed Parameter: Constant1_Value_aw
  ...
  uint16_T Constant2_Value_f;          /* Computed Parameter: Constant2_Value_f
                                        ...
                                        */
  uint16_T Constant3_Value_af;         /* Computed Parameter: Constant3_Value_af
                                        * Referenced by: '<S47>/Constant3'
                                        */
  uint16_T Constant8_Value_dl;         /* Computed Parameter: Constant8_Value_dl
  ...
  uint16_T Constant6_Value;            /* Computed Parameter: Constant6_Value
                                        ...
                                        */
  uint16_T DataStoreMemory1_InitialValue_m;/* Computed Parameter: DataStoreMemory1_InitialValue_m
                                            * Referenced by: '<S7>/Data Store Memory1'
                                            */
  uint16_T Constant_Value_n3;          /* Computed Parameter: Constant_Value_n3
  ...
  P_PID_Controller1_PID_DoubleJ_T PID_Controller6;/* '<S9>/PID_Controller6' */
  P_PID_Controller1_PID_DoubleJ_T PID_Controller5;/* '<S9>/PID_Controller5' */
  P_PID_Controller1_PID_DoubleJ_T PID_Controller4;/* '<S9>/PID_Controller4' */
  P_PID_Controller1_PID_DoubleJ_T PID_Controller3;/* '<S9>/PID_Controller3' */
  P_PID_Controller1_PID_DoubleJ_T PID_Controller2;/* '<S9>/PID_Controller2' */
  P_PID_Controller1_PID_DoubleJ_T PID_Controller1;/* '<S9>/PID_Controller1' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed5;/* '<S8>/GetAngleSpeed5' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed4;/* '<S8>/GetAngleSpeed4' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed3;/* '<S8>/GetAngleSpeed3' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed2;/* '<S8>/GetAngleSpeed2' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed1;/* '<S8>/GetAngleSpeed1' */
  P_GetAngleSpeed_PID_DoubleJoi_T GetAngleSpeed;/* '<S8>/GetAngleSpeed' */
  P_GetAngle_PID_DoubleJoints_T GetAngle5;/* '<S8>/GetAngle5' */
  P_GetAngle_PID_DoubleJoints_T GetAngle4;/* '<S8>/GetAngle4' */
  P_GetAngle_PID_DoubleJoints_T GetAngle3;/* '<S8>/GetAngle3' */
  P_GetAngle_PID_DoubleJoints_T GetAngle2;/* '<S8>/GetAngle2' */
  P_GetAngle_PID_DoubleJoints_T GetAngle1;/* '<S8>/GetAngle1' */
  P_GetAngle_PID_DoubleJoints_T GetAngle;/* '<S8>/GetAngle' */
  P_J1_BG_PID_DoubleJoints_T J6_BG;    /* '<S25>/J6_BG' */
  P_J1_BG_PID_DoubleJoints_T J5_BG;    /* '<S25>/J5_BG' */
  P_J1_BG_PID_DoubleJoints_T J4_BG;    /* '<S25>/J4_BG' */
  P_J1_BG_PID_DoubleJoints_T J3_BG;    /* '<S25>/J3_BG' */
  P_J1_BG_PID_DoubleJoints_T J2_BG;    /* '<S25>/J2_BG' */
  P_J1_BG_PID_DoubleJoints_T J1_BG;    /* '<S25>/J1_BG' */
  P_J1_TF_PID_DoubleJoints_T J6_TF;    /* '<S26>/J6_TF' */
  P_J1_TF_PID_DoubleJoints_T J5_TF;    /* '<S26>/J5_TF' */
  P_J1_TF_PID_DoubleJoints_T J4_TF;    /* '<S26>/J4_TF' */
  P_J1_TF_PID_DoubleJoints_T J3_TF;    /* '<S26>/J3_TF' */
  P_J1_TF_PID_DoubleJoints_T J2_TF;    /* '<S26>/J2_TF' */
  P_J1_TF_PID_DoubleJoints_T J1_TF;    /* '<S26>/J1_TF' */
};

/* Real-time Model Data Structure */
struct tag_RTM_PID_DoubleJoints_T {
  const char_T *errorStatus;
};

/* Block parameters (default storage) */
extern P_PID_DoubleJoints_T PID_DoubleJoints_P;

/* Block signals (default storage) */
extern B_PID_DoubleJoints_T PID_DoubleJoints_B;

/* Block states (default storage) */
extern DW_PID_DoubleJoints_T PID_DoubleJoints_DW;
...
extern void PID_DoubleJoints_initialize(void);
extern void PID_DoubleJoints_step(void);
extern void PID_DoubleJoints_terminate(void);

/* Real-time Model object */
extern RT_MODEL_PID_DoubleJoints_T *const PID_DoubleJoints_M;
 ...
 *
 * '<Root>' : 'PID_DoubleJoints'
 * '<S1>'   : 'PID_DoubleJoints/DynamicsController'
 * '<S2>'   : 'PID_DoubleJoints/GetMotorData'
 * '<S3>'   : 'PID_DoubleJoints/SendDataToGUI'
 * '<S4>'   : 'PID_DoubleJoints/Subsystem'
 * '<S5>'   : 'PID_DoubleJoints/接收上位机的数据'
 * '<S6>'   : 'PID_DoubleJoints/DynamicsController/Compensate'
 * '<S7>'   : 'PID_DoubleJoints/DynamicsController/DriveMotor'
 * '<S8>'   : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity'
 * '<S9>'   : 'PID_DoubleJoints/DynamicsController/PID_Controller'
 * '<S10>'  : 'PID_DoubleJoints/DynamicsController/关节一正弦信号发生器'
 * '<S11>'  : 'PID_DoubleJoints/DynamicsController/关节三正弦信号发生器'
 * '<S12>'  : 'PID_DoubleJoints/DynamicsController/关节二正弦信号发生器'
 * '<S13>'  : 'PID_DoubleJoints/DynamicsController/关节五正弦信号发生器'
 * '<S14>'  : 'PID_DoubleJoints/DynamicsController/关节六正弦信号发生器'
 * '<S15>'  : 'PID_DoubleJoints/DynamicsController/关节四正弦信号发生器'
 * '<S16>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver'
 * '<S17>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令'
 * '<S18>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint1'
 * '<S19>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint2'
 * '<S20>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint3'
 * '<S21>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint4'
 * '<S22>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint5'
 * '<S23>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/BottomDriver/Joint6'
 * '<S24>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2'
 * '<S25>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG'
 * '<S26>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF'
 * '<S27>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1'
 * '<S28>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/check'
 * '<S29>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/start_arm'
 * '<S30>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J1_BG'
 * '<S31>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J2_BG'
 * '<S32>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J3_BG'
 * '<S33>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J4_BG'
 * '<S34>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J5_BG'
 * '<S35>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/BG/J6_BG'
 * '<S36>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J1_TF'
 * '<S37>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J2_TF'
 * '<S38>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J3_TF'
 * '<S39>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J4_TF'
 * '<S40>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J5_TF'
 * '<S41>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/TF/J6_TF'
 * '<S42>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J1_UM1'
 * '<S43>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J2_UM1'
 * '<S44>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J3_UM1'
 * '<S45>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J4_UM1'
 * '<S46>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J5_UM1'
 * '<S47>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/UM1/J6_UM1'
 * '<S48>'  : 'PID_DoubleJoints/DynamicsController/DriveMotor/驱动器指令/Chart2/start_arm/StartRobotSubsystem'
 * '<S49>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle'
 * '<S50>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1'
 * '<S51>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2'
 * '<S52>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3'
 * '<S53>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4'
 * '<S54>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5'
 * '<S55>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed'
 * '<S56>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1'
 * '<S57>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2'
 * '<S58>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3'
 * '<S59>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4'
 * '<S60>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5'
 * '<S61>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint1'
 * '<S62>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint2'
 * '<S63>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint3'
 * '<S64>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint4'
 * '<S65>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint5'
 * '<S66>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle/Joint6'
 * '<S67>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint1'
 * '<S68>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint2'
 * '<S69>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint3'
 * '<S70>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint4'
 * '<S71>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint5'
 * '<S72>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle1/Joint6'
 * '<S73>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint1'
 * '<S74>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint2'
 * '<S75>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint3'
 * '<S76>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint4'
 * '<S77>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint5'
 * '<S78>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle2/Joint6'
 * '<S79>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint1'
 * '<S80>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint2'
 * '<S81>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint3'
 * '<S82>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint4'
 * '<S83>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint5'
 * '<S84>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle3/Joint6'
 * '<S85>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint1'
 * '<S86>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint2'
 * '<S87>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint3'
 * '<S88>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint4'
 * '<S89>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint5'
 * '<S90>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle4/Joint6'
 * '<S91>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint1'
 * '<S92>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint2'
 * '<S93>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint3'
 * '<S94>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint4'
 * '<S95>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint5'
 * '<S96>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngle5/Joint6'
 * '<S97>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint1'
 * '<S98>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint2'
 * '<S99>'  : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint3'
 * '<S100>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint4'
 * '<S101>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint5'
 * '<S102>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed/Joint6'
 * '<S103>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint1'
 * '<S104>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint2'
 * '<S105>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint3'
 * '<S106>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint4'
 * '<S107>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint5'
 * '<S108>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed1/Joint6'
 * '<S109>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint1'
 * '<S110>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint2'
 * '<S111>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint3'
 * '<S112>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint4'
 * '<S113>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint5'
 * '<S114>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed2/Joint6'
 * '<S115>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint1'
 * '<S116>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint2'
 * '<S117>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint3'
 * '<S118>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint4'
 * '<S119>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint5'
 * '<S120>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed3/Joint6'
 * '<S121>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint1'
 * '<S122>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint2'
 * '<S123>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint3'
 * '<S124>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint4'
 * '<S125>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint5'
 * '<S126>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed4/Joint6'
 * '<S127>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint1'
 * '<S128>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint2'
 * '<S129>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint3'
 * '<S130>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint4'
 * '<S131>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint5'
 * '<S132>' : 'PID_DoubleJoints/DynamicsController/GetAngleVelocity/GetAngleSpeed5/Joint6'
 * '<S133>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller1'
 * '<S134>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller2'
 * '<S135>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller3'
 * '<S136>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller4'
 * '<S137>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller5'
 * '<S138>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller6'
 * '<S139>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller1/Discrete Derivative1'
 * '<S140>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller2/Discrete Derivative1'
 * '<S141>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller3/Discrete Derivative1'
 * '<S142>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller4/Discrete Derivative1'
 * '<S143>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller5/Discrete Derivative1'
 * '<S144>' : 'PID_DoubleJoints/DynamicsController/PID_Controller/PID_Controller6/Discrete Derivative1'
 * '<S145>' : 'PID_DoubleJoints/DynamicsController/关节一正弦信号发生器/Subsystem'
 * '<S146>' : 'PID_DoubleJoints/DynamicsController/关节三正弦信号发生器/Subsystem'
 * '<S147>' : 'PID_DoubleJoints/DynamicsController/关节二正弦信号发生器/Subsystem'
 * '<S148>' : 'PID_DoubleJoints/DynamicsController/关节五正弦信号发生器/Subsystem'
 * '<S149>' : 'PID_DoubleJoints/DynamicsController/关节六正弦信号发生器/Subsystem'
 * '<S150>' : 'PID_DoubleJoints/DynamicsController/关节四正弦信号发生器/Subsystem'
 * '<S151>' : 'PID_DoubleJoints/GetMotorData/CANA_284_24'
 * '<S152>' : 'PID_DoubleJoints/GetMotorData/CANA_285_25'
 * '<S153>' : 'PID_DoubleJoints/GetMotorData/CANA_286_26'
 * '<S154>' : 'PID_DoubleJoints/GetMotorData/CANB_281_21'
 * '<S155>' : 'PID_DoubleJoints/GetMotorData/CANB_282_22'
 * '<S156>' : 'PID_DoubleJoints/GetMotorData/CANB_283_23'
 * '<S157>' : 'PID_DoubleJoints/GetMotorData/CANA_284_24/Subsystem1'
 * '<S158>' : 'PID_DoubleJoints/GetMotorData/CANA_285_25/Subsystem'
 * '<S159>' : 'PID_DoubleJoints/GetMotorData/CANA_286_26/Subsystem'
 * '<S160>' : 'PID_DoubleJoints/GetMotorData/CANB_281_21/Subsystem'
 * '<S161>' : 'PID_DoubleJoints/GetMotorData/CANB_282_22/Subsystem'
 * '<S162>' : 'PID_DoubleJoints/GetMotorData/CANB_283_23/Subsystem'
 * '<S163>' : 'PID_DoubleJoints/SendDataToGUI/  '
 * '<S164>' : 'PID_DoubleJoints/SendDataToGUI/广播周期'
 * '<S165>' : 'PID_DoubleJoints/SendDataToGUI/广播周期/Increment Real World'
 * '<S166>' : 'PID_DoubleJoints/SendDataToGUI/广播周期/Wrap To Zero'
 * '<S167>' : 'PID_DoubleJoints/接收上位机的数据/0x0080'
 * '<S168>' : 'PID_DoubleJoints/接收上位机的数据/0x88'
 * '<S169>' : 'PID_DoubleJoints/接收上位机的数据/Compare To Constant1'
 * '<S170>' : 'PID_DoubleJoints/接收上位机的数据/Compare To Constant2'
 * '<S171>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem'
 * '<S172>' : 'PID_DoubleJoints/接收上位机的数据/获取用户命令'
 * '<S173>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint1'
 * '<S174>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint2'
 * '<S175>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint3'
 * '<S176>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint4'
 * '<S177>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint5'
 * '<S178>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint6'
 * '<S179>' : 'PID_DoubleJoints/接收上位机的数据/Subsystem/Joint7'
 * '<S180>' : 'PID_DoubleJoints/接收上位机的数据/获取用户命令/消息校验'
 */
#endif                                 /* RTW_HEADER_PID_DoubleJoints_h_ */
