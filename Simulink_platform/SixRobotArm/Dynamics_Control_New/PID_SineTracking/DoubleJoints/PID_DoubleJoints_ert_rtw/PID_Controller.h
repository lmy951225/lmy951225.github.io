...
} DW_PID_Controller1_PID_Double_T;

/* Parameters for system: '<S9>/PID_Controller1' */
struct P_PID_Controller1_PID_DoubleJ_T_ {
...
extern void PID_Double_PID_Controller1_Init(DW_PID_Controller1_PID_Double_T
  *localDW, P_PID_Controller1_PID_DoubleJ_T *localP);
extern void PID_DoubleJoint_PID_Controller1(real_T rtu_error, real_T rtu_KP,
  real_T rtu_KI, real_T rtu_KD, real_T *rty_Tau, DW_PID_Controller1_PID_Double_T
  *localDW, P_PID_Controller1_PID_DoubleJ_T *localP);
