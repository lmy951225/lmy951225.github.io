...
P_PID_DoubleJoints_T PID_DoubleJoints_P = {
  ...
  /* Computed Parameter: MSG_Y0_e
   * Referenced by: '<S26>/MSG'
   */
  0U,

  /* Computed Parameter: MSG_Y0_b
  ...
  /* Computed Parameter: Constant1_Value_pe
  ...
  /* Computed Parameter: Constant1_Value_at
  ...
  /* Computed Parameter: Constant1_Value_aw
  ...
  /* Computed Parameter: Constant3_Value_af
   * Referenced by: '<S47>/Constant3'
   */
  1U,

  /* Computed Parameter: Constant8_Value_dl
  ...
  /* Computed Parameter: DataStoreMemory1_InitialValue_m
