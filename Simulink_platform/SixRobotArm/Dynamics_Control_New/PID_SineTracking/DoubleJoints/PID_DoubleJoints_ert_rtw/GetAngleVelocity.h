...
struct P_GetAngleSpeed_PID_DoubleJoi_T_ {
...
extern void PID_DoubleJoints_GetAngle_Init(B_GetAngle_PID_DoubleJoints_T *localB,
  P_GetAngle_PID_DoubleJoints_T *localP);
extern void PID_DoubleJoints_GetAngle(real_T *rty_Angle,
  B_GetAngle_PID_DoubleJoints_T *localB, P_GetAngle_PID_DoubleJoints_T *localP,
  uint16_T rtp_JJoint, real_T rtp_InitAngle);
extern void PID_DoubleJo_GetAngleSpeed_Init(B_GetAngleSpeed_PID_DoubleJoi_T
  *localB, P_GetAngleSpeed_PID_DoubleJoi_T *localP);
extern void PID_DoubleJoints_GetAngleSpeed(real_T *rty_Velcity,
