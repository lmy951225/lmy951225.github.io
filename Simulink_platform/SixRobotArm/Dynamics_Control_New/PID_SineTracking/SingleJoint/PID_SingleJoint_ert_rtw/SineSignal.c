 ...
 *    '<S15>/Subsystem'
 */
void PID_SingleJoint_Subsystem_Init(real_T *rty_u, real_T *rty_u_c,
 ...
 *    '<S15>/Subsystem'
 */
void PID_SingleJoint_Subsystem_Start(DW_Subsystem_PID_SingleJoint_T *localDW,
  P_Subsystem_PID_SingleJoint_T *localP)
{
 ...
 *    '<S15>/Subsystem'
 */
void PID_SingleJoint_Subsystem(real_T rtu_Enable, real_T rtu_rad, real_T rtu_u,
  real_T *rty_u, real_T *rty_u_c, DW_Subsystem_PID_SingleJoint_T *localDW,
                     ...
                     P_SineSignal_T *localP)
{
  ...
  PID_SingleJoint_Subsystem_Init(rty_qd, rty_e, &localDW->Subsystem,
    &localP->Subsystem);
...
void SineSignal_Start(DW_SineSignal_T *localDW, P_SineSignal_T *localP)
{
  ...
  PID_SingleJoint_Subsystem_Start(&localDW->Subsystem, &localP->Subsystem);
                ...
                DW_SineSignal_T *localDW, P_SineSignal_T *localP)
{
   ...
   *  Gain: '<S10>/Gain14'
   */
  PID_SingleJoint_Subsystem(rtu_En, rtu_q, localP->Gain14_Gain *
