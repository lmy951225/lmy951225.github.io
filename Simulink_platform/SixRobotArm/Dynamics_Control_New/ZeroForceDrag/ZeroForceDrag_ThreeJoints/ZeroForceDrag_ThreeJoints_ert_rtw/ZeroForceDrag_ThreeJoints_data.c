/*
 * File: ZeroForceDrag_ThreeJoints_data.c
 *
...
P_ZeroForceDrag_ThreeJoints_T ZeroForceDrag_ThreeJoints_P = {
  ...
  /* Computed Parameter: MSG_Y0_d
   * Referenced by: '<S19>/MSG'
   */
  0U,

  /* Computed Parameter: MSG_Y0_h
  ...
  /* Computed Parameter: Constant1_Value_mf
  ...
  /* Computed Parameter: Constant1_Value_kx
  ...
  /* Computed Parameter: Constant8_Value_fr
  ...
  /* Computed Parameter: Constant3_Value_lp
  ...
  /* Computed Parameter: Constant2_Value_i3
  ...
  /* Computed Parameter: DataStoreMemory1_InitialValue_l
