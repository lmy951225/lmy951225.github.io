 ...
 *    '<S8>/GetAngle5'
 */
void ZeroForceDrag_Thr_GetAngle_Init(B_GetAngle_ZeroForceDrag_Thre_T *localB,
  P_GetAngle_ZeroForceDrag_Thre_T *localP)
{
 ...
 *    '<S8>/GetAngle5'
 */
void ZeroForceDrag_ThreeJoi_GetAngle(real_T *rty_Angle,
  B_GetAngle_ZeroForceDrag_Thre_T *localB, P_GetAngle_ZeroForceDrag_Thre_T
 ...
 *    '<S8>/GetAngleSpeed5'
 */
void ZeroForceDrag_Thr_GetAngleSpeed(real_T *rty_Velcity,
...
void GetAngleVelocity_Init(void)
{
  ...
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed1' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed1,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed1);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed1' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed2' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed2,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed2);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed2' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed3' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed3,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed3);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed3' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed4' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed4,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed4);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed4' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed5' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_ThreeJoints_B.GetAngleSpeed5,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed5);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed5' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle,
    &ZeroForceDrag_ThreeJoints_P.GetAngle);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle1' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle1,
    &ZeroForceDrag_ThreeJoints_P.GetAngle1);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle1' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle2' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle2,
    &ZeroForceDrag_ThreeJoints_P.GetAngle2);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle2' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle3' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle3,
    &ZeroForceDrag_ThreeJoints_P.GetAngle3);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle3' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle4' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle4,
    &ZeroForceDrag_ThreeJoints_P.GetAngle4);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle4' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle5' */
  ZeroForceDrag_Thr_GetAngle_Init(&ZeroForceDrag_ThreeJoints_B.GetAngle5,
    &ZeroForceDrag_ThreeJoints_P.GetAngle5);
...
void GetAngleVelocity(void)
{
  ...
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.Gain9_f,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed1' */
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.Gain9_g,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed1,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed1,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed1_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed2' */
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.Gain9_d,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed2,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed2,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed2_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed3' */
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.Gain9_h,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed3,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed3,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed3_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed4' */
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.Gain9,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed4,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed4,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed4_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed5' */
  ZeroForceDrag_Thr_GetAngleSpeed(&ZeroForceDrag_ThreeJoints_B.u,
    &ZeroForceDrag_ThreeJoints_B.GetAngleSpeed5,
    &ZeroForceDrag_ThreeJoints_P.GetAngleSpeed5,
    ZeroForceDrag_ThreeJoints_P.GetAngleSpeed5_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed5' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation2,
    &ZeroForceDrag_ThreeJoints_B.GetAngle, &ZeroForceDrag_ThreeJoints_P.GetAngle,
    ZeroForceDrag_ThreeJoints_P.GetAngle_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle1' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation1,
    &ZeroForceDrag_ThreeJoints_B.GetAngle1,
    &ZeroForceDrag_ThreeJoints_P.GetAngle1,
    ZeroForceDrag_ThreeJoints_P.GetAngle1_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle1_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle2' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation3,
    &ZeroForceDrag_ThreeJoints_B.GetAngle2,
    &ZeroForceDrag_ThreeJoints_P.GetAngle2,
    ZeroForceDrag_ThreeJoints_P.GetAngle2_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle2_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle3' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation4,
    &ZeroForceDrag_ThreeJoints_B.GetAngle3,
    &ZeroForceDrag_ThreeJoints_P.GetAngle3,
    ZeroForceDrag_ThreeJoints_P.GetAngle3_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle3_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle4' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation5,
    &ZeroForceDrag_ThreeJoints_B.GetAngle4,
    &ZeroForceDrag_ThreeJoints_P.GetAngle4,
    ZeroForceDrag_ThreeJoints_P.GetAngle4_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle4_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle5' */
  ZeroForceDrag_ThreeJoi_GetAngle(&ZeroForceDrag_ThreeJoints_B.Saturation6,
    &ZeroForceDrag_ThreeJoints_B.GetAngle5,
    &ZeroForceDrag_ThreeJoints_P.GetAngle5,
    ZeroForceDrag_ThreeJoints_P.GetAngle5_JJoint,
    ZeroForceDrag_ThreeJoints_P.GetAngle5_InitAngle);
