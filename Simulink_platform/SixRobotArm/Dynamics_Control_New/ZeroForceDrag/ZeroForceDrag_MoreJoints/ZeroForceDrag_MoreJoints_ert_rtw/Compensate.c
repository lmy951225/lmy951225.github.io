...
void Compensate(void)
{
   ...
   *  Gain: '<S6>/Gain'
   */
  rtb_Add9 = ZeroForceDrag_MoreJoints_P.Gain_Gain * q[2] + q[1];
   ...
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain9_Gain * dq[1];
   ...
   */
  ZeroForceDrag_MoreJoints_B.Saturation2 = ((sin(q[1]) * J2[2] + rtb_Product14)
    + sin(rtb_Add9) * J2[4]) + (J2[0] * u + dq[1] * J2[1]);

  /* Gain: '<S6>/Gain2' incorporates:
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain2_Gain * dq[4];
   ...
   *  Product: '<S6>/Product2'
   */
  ZeroForceDrag_MoreJoints_B.Saturation1 = J5[0] * u + dq[4] * J5[1];

  /* Gain: '<S6>/Gain1' incorporates:
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain1_Gain * dq[0];
   ...
   */
  ZeroForceDrag_MoreJoints_B.Saturation3 = J1[0] * u + dq[0] * J1[1];

  /* Sum: '<S6>/Add8' incorporates:
   *  DataStoreRead: '<S1>/q'
   *  Gain: '<S6>/Gain6'
   */
  rtb_Add9 = ZeroForceDrag_MoreJoints_P.Gain6_Gain * q[2] + q[1];

  /* Gain: '<S6>/Gain4' incorporates:
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain4_Gain * dq[2];
   ...
   */
  ZeroForceDrag_MoreJoints_B.Saturation4 = (sin(rtb_Add9 + q[3]) * J3[3] + sin
    (rtb_Add9) * J3[2]) + (J3[0] * u + dq[2] * J3[1]);

  /* Gain: '<S6>/Gain5' incorporates:
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain5_Gain * dq[3];
   ...
   */
  ZeroForceDrag_MoreJoints_B.Saturation5 = sin
    ((ZeroForceDrag_MoreJoints_P.Gain7_Gain * q[2] + q[1]) + q[3]) * J4[2] +
    (J4[0] * u + dq[3] * J4[1]);

  /* Gain: '<S6>/Gain3' incorporates:
   *  DataStoreRead: '<S1>/dq'
   */
  u = ZeroForceDrag_MoreJoints_P.Gain3_Gain * dq[5];
   ...
   *  Product: '<S6>/Product4'
   */
  ZeroForceDrag_MoreJoints_B.Saturation6 = J6[0] * u + dq[5] * J6[1];
}
