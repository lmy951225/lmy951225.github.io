/*
 * File: ZeroForceDrag_DoubleJoints.c
 *
...
B_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_B;

/* Block states (default storage) */
DW_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_DW;

/* Real-time model */
RT_MODEL_ZeroForceDrag_Double_T ZeroForceDrag_DoubleJoints_M_;
RT_MODEL_ZeroForceDrag_Double_T *const ZeroForceDrag_DoubleJoints_M =
  &ZeroForceDrag_DoubleJoints_M_;
...
void idle_num0_task_fcn(void)
{
  /* Call the system: <Root>/接收上位机的数据 */
  {
    ...
    /* Output and update for function-call system: '<Root>/接收上位机的数据' */
    {
      ...
      ZeroForceDrag_DoubleJoints_u_h();
       ...
       */
      if (ZeroForceDrag_DoubleJoints_B.Switch[0] ==
          ZeroForceDrag_DoubleJoints_P.ux88_const) {
        /* SwitchCase: '<S134>/Switch Case' */
        switch ((int32_T)ZeroForceDrag_DoubleJoints_B.Switch[1]) {
         case 1L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J1[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 2L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J2[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 3L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J3[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 4L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J4[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 5L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J5[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 6L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J6[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
         ...
         case 7L:
           ...
           */
          for (i = 0; i < 6; i++) {
            J7[i] = (int16_T)ZeroForceDrag_DoubleJoints_B.Switch[i + 2];
          }
       ...
       */
      StartRobot = (uint16_T)((ZeroForceDrag_DoubleJoints_B.Switch[0] ==
        ZeroForceDrag_DoubleJoints_P.ux0080_const) &&
        ZeroForceDrag_DoubleJoints_DW.PTX &&
        (ZeroForceDrag_DoubleJoints_B.Switch[2] ==
         ZeroForceDrag_DoubleJoints_P.CompareToConstant1_const) &&
        (ZeroForceDrag_DoubleJoints_B.Switch[3] ==
         ZeroForceDrag_DoubleJoints_P.CompareToConstant2_const));
    }
...
void ZeroForceDrag_DoubleJ_u_b_Start(void)
{
  /* Start for S-Function (c28xsci_rx): '<S135>/ ' */

  /* Initialize ZeroForceDrag_DoubleJoints_B._o1[0] */
  {
    ZeroForceDrag_DoubleJoints_B._o1[0] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[1] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[2] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[3] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[4] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[5] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[6] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[7] = (uint16_T)0.0;
    ZeroForceDrag_DoubleJoints_B._o1[8] = (uint16_T)0.0;
  }
}

/* Output and update for atomic system: '<S4>/获取用户命令' */
void ZeroForceDrag_DoubleJoints_u_h(void)
{
  ...
  /* S-Function (c28xsci_rx): '<S135>/ ' */
  {
    ...
    if (errFlg != NOERROR)
      goto RXERRA;
    memcpy( &ZeroForceDrag_DoubleJoints_B._o1[0], recbuff, 9);
   RXERRA:
    asm(" NOP");
    ZeroForceDrag_DoubleJoints_B._o2 = errFlg;
  }

  /* RelationalOperator: '<S143>/Relational Operator' incorporates:
   *  Sum: '<S143>/Add'
   */
  rtb_RelationalOperator = (((((((ZeroForceDrag_DoubleJoints_B._o1[0] +
    ZeroForceDrag_DoubleJoints_B._o1[1]) + ZeroForceDrag_DoubleJoints_B._o1[2])
    + ZeroForceDrag_DoubleJoints_B._o1[3]) + ZeroForceDrag_DoubleJoints_B._o1[4])
    + ZeroForceDrag_DoubleJoints_B._o1[5]) + ZeroForceDrag_DoubleJoints_B._o1[6])
    + ZeroForceDrag_DoubleJoints_B._o1[7] == ZeroForceDrag_DoubleJoints_B._o1[8]);
  ...
  for (i = 0; i < 9; i++) {
    if (rtb_RelationalOperator) {
      ZeroForceDrag_DoubleJoints_B.Switch[i] =
        ZeroForceDrag_DoubleJoints_B._o1[i];
    } else {
      ZeroForceDrag_DoubleJoints_B.Switch[i] =
        ZeroForceDrag_DoubleJoints_P.Constant_Value_p[i];
    }
  }
   ...
   */
  if (ZeroForceDrag_DoubleJoints_B._o2 >
      ZeroForceDrag_DoubleJoints_P.Switch_Threshold_o) {
    tmp = ZeroForceDrag_DoubleJoints_P.Constant_Value_fd;
  } else {
    tmp = ZeroForceDrag_DoubleJoints_P.Constant1_Value_k;
  }
   ...
   */
  ZeroForceDrag_DoubleJoints_DW.PTX = (rtb_RelationalOperator && tmp);
}
...
void ZeroForceDra_SendDataToGUI_Init(void)
{
  ...
  ZeroForceDrag_DoubleJoints_DW.Output_DSTATE =
    ZeroForceDrag_DoubleJoints_P.Output_InitialCondition;
}

/* Output and update for atomic system: '<Root>/SendDataToGUI' */
void ZeroForceDrag_Dou_SendDataToGUI(void)
{
  uint16_T rtb_DataTypeConversion12[18];
  int16_T i;
  uint16_T rtb_DataTypeConversion12_j;
  real_T tmp;
  boolean_T tmp_0;
   ...
   */
  if (ZeroForceDrag_DoubleJoints_DW.Output_DSTATE >
      ZeroForceDrag_DoubleJoints_P.Switch_Threshold_d) {
    tmp_0 = ZeroForceDrag_DoubleJoints_P.Constant1_Value_n;
  } else {
    tmp_0 = ZeroForceDrag_DoubleJoints_P.Constant_Value_g;
  }
  ...
  if (tmp_0) {
     ...
     */
    ZeroForceDrag_DoubleJoints_B.TmpSignalConversionAtSCITransmi[0] =
      ZeroForceDrag_DoubleJoints_P.Constant1_Value_m;
    for (i = 0; i < 18; i++) {
      ...
      rtb_DataTypeConversion12_j = tmp < 0.0 ? (uint16_T)-(int16_T)(uint16_T)
        -tmp : (uint16_T)tmp;

      /* SignalConversion: '<S126>/TmpSignal ConversionAtSCI TransmitInport1' */
      ZeroForceDrag_DoubleJoints_B.TmpSignalConversionAtSCITransmi[i + 1] =
        rtb_DataTypeConversion12_j;

      /* DataTypeConversion: '<S126>/Data Type Conversion12' */
      rtb_DataTypeConversion12[i] = rtb_DataTypeConversion12_j;
    }
     ...
     *  Sum: '<S126>/校验码填充'
     */
    ZeroForceDrag_DoubleJoints_B.TmpSignalConversionAtSCITransmi[19] =
      (((((((((((((((((ZeroForceDrag_DoubleJoints_P.Constant1_Value_m +
  ...
  ZeroForceDrag_DoubleJoints_DW.Output_DSTATE =
    (ZeroForceDrag_DoubleJoints_DW.Output_DSTATE +
     ZeroForceDrag_DoubleJoints_P.FixPtConstant_Value) & 255U;
   ...
   */
  if (ZeroForceDrag_DoubleJoints_DW.Output_DSTATE >
      ZeroForceDrag_DoubleJoints_P._uplimit) {
    ZeroForceDrag_DoubleJoints_DW.Output_DSTATE =
      ZeroForceDrag_DoubleJoints_P.Constant_Value_a;
  }
...
void ZeroForceDrag_CANA_284_24_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANA_284_24(void)
{
  /* S-Function (c280xcanrcv): '<S144>/eCAN Receive1' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP24) {
      ...
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[0] =
        ECanaMboxes.MBOX24.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[1] =
        ECanaMboxes.MBOX24.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[2] =
        ECanaMboxes.MBOX24.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[3] =
        ECanaMboxes.MBOX24.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[4] =
        ECanaMboxes.MBOX24.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[5] =
        ECanaMboxes.MBOX24.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[6] =
        ECanaMboxes.MBOX24.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[7] =
      ...
      Motor_Position[3L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[7] << 24U);
       ...
       *  Sum: '<S150>/Add2'
       */
      Motor_Current[3L] = ((int16_T)
                           ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[1] << 8U)
        + (int16_T)ZeroForceDrag_DoubleJoints_B.eCANReceive1_o2[0];
    }
  }
...
void ZeroForceDrag_CANA_285_25_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANA_285_25(void)
{
  /* S-Function (c280xcanrcv): '<S145>/eCAN Receive' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP25) {
      ...
      ECanaRegs.CANRMP.all = ECanaShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[0] =
        ECanaMboxes.MBOX25.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[1] =
        ECanaMboxes.MBOX25.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[2] =
        ECanaMboxes.MBOX25.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[3] =
        ECanaMboxes.MBOX25.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[4] =
        ECanaMboxes.MBOX25.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[5] =
        ECanaMboxes.MBOX25.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[6] =
        ECanaMboxes.MBOX25.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[7] =
      ...
      Motor_Position[4L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_e[7] << 24U);
...
void ZeroForceDrag_CANA_286_26_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANA_286_26(void)
{
  /* S-Function (c280xcanrcv): '<S146>/eCAN Receive' */
  {
    ...
    if (ECanaRegs.CANRMP.bit.RMP26) {
      ...
      ECanaRegs.CANRMP.all = ECanaShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[0] =
        ECanaMboxes.MBOX26.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[1] =
        ECanaMboxes.MBOX26.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[2] =
        ECanaMboxes.MBOX26.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[3] =
        ECanaMboxes.MBOX26.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[4] =
        ECanaMboxes.MBOX26.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[5] =
        ECanaMboxes.MBOX26.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[6] =
        ECanaMboxes.MBOX26.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[7] =
      ...
      Motor_Position[5L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_pv[7] << 24U);
...
void ZeroForceDrag_CANB_281_21_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANB_281_21(void)
{
  /* S-Function (c280xcanrcv): '<S147>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP21) {
      ...
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[0] =
        ECanbMboxes.MBOX21.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[1] =
        ECanbMboxes.MBOX21.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[2] =
        ECanbMboxes.MBOX21.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[3] =
        ECanbMboxes.MBOX21.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[4] =
        ECanbMboxes.MBOX21.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[5] =
        ECanbMboxes.MBOX21.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[6] =
        ECanbMboxes.MBOX21.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[7] =
      ...
      Motor_Position[0L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_k[7] << 24U);
...
void ZeroForceDrag_CANB_282_22_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANB_282_22(void)
{
  /* S-Function (c280xcanrcv): '<S148>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP22) {
      ...
      ECanbRegs.CANRMP.all = ECanbShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[0] =
        ECanbMboxes.MBOX22.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[1] =
        ECanbMboxes.MBOX22.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[2] =
        ECanbMboxes.MBOX22.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[3] =
        ECanbMboxes.MBOX22.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[4] =
        ECanbMboxes.MBOX22.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[5] =
        ECanbMboxes.MBOX22.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[6] =
        ECanbMboxes.MBOX22.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[7] =
      ...
      Motor_Position[1L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[7] << 24U);
      ...
      Motor_Current[1L] = ((int32_T)
                           ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[1] <<
                           8U) + ZeroForceDrag_DoubleJoints_B.eCANReceive_o2_p[0];
    }
  }
...
void ZeroForceDrag_CANB_283_23_Start(void)
{
  ...
  /* Initialize ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[0] */
  {
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[0] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[1] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[2] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[3] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[4] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[5] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[6] = (uint8_T)0.0;
    ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[7] = (uint8_T)0.0;
  }
...
void ZeroForceDrag_Doubl_CANB_283_23(void)
{
  /* S-Function (c280xcanrcv): '<S149>/eCAN Receive' */
  {
    ...
    if (ECanbRegs.CANRMP.bit.RMP23) {
      ...
      ECanbRegs.CANRMP.all = ECanbShadow.CANRMP.all;/* 32-bit register access is reliable only                         */
      EDIS;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[0] =
        ECanbMboxes.MBOX23.MDL.byte.BYTE3;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[1] =
        ECanbMboxes.MBOX23.MDL.byte.BYTE2;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[2] =
        ECanbMboxes.MBOX23.MDL.byte.BYTE1;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[3] =
        ECanbMboxes.MBOX23.MDL.byte.BYTE0;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[4] =
        ECanbMboxes.MBOX23.MDH.byte.BYTE7;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[5] =
        ECanbMboxes.MBOX23.MDH.byte.BYTE6;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[6] =
        ECanbMboxes.MBOX23.MDH.byte.BYTE5;
      ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[7] =
       ...
       *  Sum: '<S155>/Add1'
       */
      Motor_Velocity[2L] = ((int16_T)
                            ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[3] << 8U)
        + (int16_T)ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[2];
      ...
      Motor_Position[2L] = ((((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[5] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[4]) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[6] << 16U)) + ((int32_T)
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[7] << 24U);
       ...
       *  Sum: '<S155>/Add2'
       */
      Motor_Current[2L] = ((int32_T)ZeroForceDrag_DoubleJoints_B.eCANReceive_o2
                           [1] << 8U) +
        ZeroForceDrag_DoubleJoints_B.eCANReceive_o2[0];
    }
  }
...
void ZeroForceDrag_DoubleJ_u_e_Start(void)
{
...
void ZeroForceDrag_DoubleJoints_step(void)
{
  ...
  ZeroForceDrag_Dou_SendDataToGUI();

  /* End of Outputs for SubSystem: '<Root>/SendDataToGUI' */
}

/* Model initialize function */
void ZeroForceDrag_DoubleJoints_initialize(void)
{
  /* Registration code */
  ...
  rtmSetErrorStatus(ZeroForceDrag_DoubleJoints_M, (NULL));

  /* block I/O */
  (void) memset(((void *) &ZeroForceDrag_DoubleJoints_B), 0,
                sizeof(B_ZeroForceDrag_DoubleJoints_T));

  /* states (dwork) */
  (void) memset((void *)&ZeroForceDrag_DoubleJoints_DW, 0,
                sizeof(DW_ZeroForceDrag_DoubleJoints_T));
...

  {
    ...
    ZeroForceDrag_DoubleJ_u_e_Start();
    ...
    ZeroForceDrag_DoubleJ_u_b_Start();

    /* End of Start for SubSystem: '<S4>/获取用户命令' */

    /* Start for DataStoreMemory: '<S4>/消息使能' */
    ZeroForceDrag_DoubleJoints_DW.PTX =
      ZeroForceDrag_DoubleJoints_P._InitialValue_k;
    for (i = 0; i < 6; i++) {
      /* Start for DataStoreMemory: '<Root>/Data Store Memory1' */
      Motor_Position[i] =
        ZeroForceDrag_DoubleJoints_P.DataStoreMemory1_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory10' */
      J7[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory10_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory11' */
      Motor_Current[i] =
        ZeroForceDrag_DoubleJoints_P.DataStoreMemory11_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory13' */
      J1[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory13_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory2' */
      Motor_Velocity[i] =
        ZeroForceDrag_DoubleJoints_P.DataStoreMemory2_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory3' */
      J2[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory3_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory4' */
      J3[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory4_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory5' */
      J4[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory5_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory6' */
      J5[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory6_InitialValue[i];

      /* Start for DataStoreMemory: '<Root>/Data Store Memory7' */
      J6[i] = ZeroForceDrag_DoubleJoints_P.DataStoreMemory7_InitialValue[i];
    }

    /* Start for DataStoreMemory: '<Root>/Data Store Memory8' */
    memcpy(&Send_GUIdata[0],
           &ZeroForceDrag_DoubleJoints_P.DataStoreMemory8_InitialValue[0], 18U *
           sizeof(real_T));

    /* Start for DataStoreMemory: '<Root>/Data Store Memory9' */
    StartRobot = ZeroForceDrag_DoubleJoints_P.DataStoreMemory9_InitialValue;
...
void ZeroForceDrag_DoubleJoints_terminate(void)
{
