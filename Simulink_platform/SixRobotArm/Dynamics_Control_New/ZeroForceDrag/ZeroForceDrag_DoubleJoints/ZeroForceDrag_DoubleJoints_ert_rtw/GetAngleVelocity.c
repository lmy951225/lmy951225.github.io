 ...
 *    '<S8>/GetAngle5'
 */
void ZeroForceDrag_Dou_GetAngle_Init(B_GetAngle_ZeroForceDrag_Doub_T *localB,
  P_GetAngle_ZeroForceDrag_Doub_T *localP)
{
 ...
 *    '<S8>/GetAngle5'
 */
void ZeroForceDrag_DoubleJo_GetAngle(real_T *rty_Angle,
  B_GetAngle_ZeroForceDrag_Doub_T *localB, P_GetAngle_ZeroForceDrag_Doub_T
 ...
 *    '<S8>/GetAngleSpeed5'
 */
void ZeroForceDrag_Dou_GetAngleSpeed(real_T *rty_Velcity,
...
void GetAngleVelocity_Init(void)
{
  ...
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed1' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed1,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed1);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed1' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed2' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed2,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed2);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed2' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed3' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed3,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed3);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed3' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed4' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed4,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed4);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed4' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngleSpeed5' */
  ZeroForceDra_GetAngleSpeed_Init(&ZeroForceDrag_DoubleJoints_B.GetAngleSpeed5,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed5);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngleSpeed5' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle,
    &ZeroForceDrag_DoubleJoints_P.GetAngle);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle1' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle1,
    &ZeroForceDrag_DoubleJoints_P.GetAngle1);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle1' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle2' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle2,
    &ZeroForceDrag_DoubleJoints_P.GetAngle2);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle2' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle3' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle3,
    &ZeroForceDrag_DoubleJoints_P.GetAngle3);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle3' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle4' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle4,
    &ZeroForceDrag_DoubleJoints_P.GetAngle4);

  /* End of SystemInitialize for SubSystem: '<S8>/GetAngle4' */

  /* SystemInitialize for Atomic SubSystem: '<S8>/GetAngle5' */
  ZeroForceDrag_Dou_GetAngle_Init(&ZeroForceDrag_DoubleJoints_B.GetAngle5,
    &ZeroForceDrag_DoubleJoints_P.GetAngle5);
...
void GetAngleVelocity(void)
{
  ...
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.Gain9_b,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed1' */
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.Gain9_e,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed1,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed1,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed1_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed2' */
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.Gain9_c4,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed2,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed2,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed2_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed3' */
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.Gain9_c,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed3,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed3,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed3_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed4' */
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.Gain9,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed4,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed4,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed4_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngleSpeed5' */
  ZeroForceDrag_Dou_GetAngleSpeed(&ZeroForceDrag_DoubleJoints_B.u,
    &ZeroForceDrag_DoubleJoints_B.GetAngleSpeed5,
    &ZeroForceDrag_DoubleJoints_P.GetAngleSpeed5,
    ZeroForceDrag_DoubleJoints_P.GetAngleSpeed5_JJoint);

  /* End of Outputs for SubSystem: '<S8>/GetAngleSpeed5' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation2,
    &ZeroForceDrag_DoubleJoints_B.GetAngle,
    &ZeroForceDrag_DoubleJoints_P.GetAngle,
    ZeroForceDrag_DoubleJoints_P.GetAngle_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle1' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation1,
    &ZeroForceDrag_DoubleJoints_B.GetAngle1,
    &ZeroForceDrag_DoubleJoints_P.GetAngle1,
    ZeroForceDrag_DoubleJoints_P.GetAngle1_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle1_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle1' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle2' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation3,
    &ZeroForceDrag_DoubleJoints_B.GetAngle2,
    &ZeroForceDrag_DoubleJoints_P.GetAngle2,
    ZeroForceDrag_DoubleJoints_P.GetAngle2_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle2_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle2' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle3' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation4,
    &ZeroForceDrag_DoubleJoints_B.GetAngle3,
    &ZeroForceDrag_DoubleJoints_P.GetAngle3,
    ZeroForceDrag_DoubleJoints_P.GetAngle3_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle3_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle3' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle4' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation5,
    &ZeroForceDrag_DoubleJoints_B.GetAngle4,
    &ZeroForceDrag_DoubleJoints_P.GetAngle4,
    ZeroForceDrag_DoubleJoints_P.GetAngle4_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle4_InitAngle);

  /* End of Outputs for SubSystem: '<S8>/GetAngle4' */

  /* Outputs for Atomic SubSystem: '<S8>/GetAngle5' */
  ZeroForceDrag_DoubleJo_GetAngle(&ZeroForceDrag_DoubleJoints_B.Saturation6,
    &ZeroForceDrag_DoubleJoints_B.GetAngle5,
    &ZeroForceDrag_DoubleJoints_P.GetAngle5,
    ZeroForceDrag_DoubleJoints_P.GetAngle5_JJoint,
    ZeroForceDrag_DoubleJoints_P.GetAngle5_InitAngle);
