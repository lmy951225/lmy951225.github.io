/*
 * File: ZeroForceDrag_DoubleJoints.h
 *
...
#ifndef RTW_HEADER_ZeroForceDrag_DoubleJoints_h_
#define RTW_HEADER_ZeroForceDrag_DoubleJoints_h_
#include <math.h>
#include <string.h>
#include <stddef.h>
...
typedef struct {
  ...
  real_T Gain9_c;                      /* '<S51>/Gain9' */
  real_T Gain9_c4;                     /* '<S50>/Gain9' */
  real_T Gain9_e;                      /* '<S49>/Gain9' */
  real_T Gain9_b;                      /* '<S48>/Gain9' */
  ...
  uint16_T StartRobot_a;               /* '<S10>/Chart2' */
  uint16_T In1;                        /* '<S41>/In1' */
  uint16_T DataTypeConversion[8];      /* '<S40>/Data Type Conversion' */
  uint16_T DataTypeConversion_b[8];    /* '<S39>/Data Type Conversion' */
  uint16_T DataTypeConversion_m[8];    /* '<S38>/Data Type Conversion' */
  uint16_T DataTypeConversion_e[8];    /* '<S37>/Data Type Conversion' */
  uint16_T DataTypeConversion_a[8];    /* '<S36>/Data Type Conversion' */
  uint16_T DataTypeConversion_j[8];    /* '<S35>/Data Type Conversion' */
  uint16_T TmpSignalConversionAtSCITransmi[20];
  uint16_T eCANReceive_o2[8];          /* '<S149>/eCAN Receive' */
  uint16_T eCANReceive_o2_p[8];        /* '<S148>/eCAN Receive' */
  uint16_T eCANReceive_o2_k[8];        /* '<S147>/eCAN Receive' */
  uint16_T eCANReceive_o2_pv[8];       /* '<S146>/eCAN Receive' */
  uint16_T eCANReceive_o2_e[8];        /* '<S145>/eCAN Receive' */
  ...
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle5;/* '<S8>/GetAngle5' */
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle4;/* '<S8>/GetAngle4' */
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle3;/* '<S8>/GetAngle3' */
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle2;/* '<S8>/GetAngle2' */
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle1;/* '<S8>/GetAngle1' */
  B_GetAngle_ZeroForceDrag_Doub_T GetAngle;/* '<S8>/GetAngle' */
} B_ZeroForceDrag_DoubleJoints_T;
...
typedef struct {
  ...
  uint16_T is_active_c5_ZeroForceDrag_Doub;/* '<S10>/Chart2' */
  uint16_T is_c5_ZeroForceDrag_DoubleJoint;/* '<S10>/Chart2' */
  boolean_T PTX;                       /* '<S4>/消息使能' */
} DW_ZeroForceDrag_DoubleJoints_T;

/* Parameters (default storage) */
struct P_ZeroForceDrag_DoubleJoints_T_ {
  ...
  boolean_T _InitialValue_k;           /* Expression: true
                                        ...
                                        */
  boolean_T Constant_Value_g;          /* Expression: true
  ...
  uint16_T Constant8_Value_l;          /* Computed Parameter: Constant8_Value_l
                                        ...
                                        */
  uint16_T Constant1_Value_np;         /* Computed Parameter: Constant1_Value_np
  ...
  uint16_T Constant2_Value_b;          /* Computed Parameter: Constant2_Value_b
                                        ...
                                        */
  uint16_T Constant3_Value_jx;         /* Computed Parameter: Constant3_Value_jx
                                        * Referenced by: '<S40>/Constant3'
                                        */
  uint16_T Constant8_Value_b;          /* Computed Parameter: Constant8_Value_b
                                        * Referenced by: '<S40>/Constant8'
                                        */
  uint16_T Constant_Value_bn;          /* Computed Parameter: Constant_Value_bn
  ...
  uint16_T Constant6_Value;            /* Computed Parameter: Constant6_Value
                                        ...
                                        */
  uint16_T DataStoreMemory1_InitialValue_a;/* Computed Parameter: DataStoreMemory1_InitialValue_a
  ...
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle5;/* '<S8>/GetAngle5' */
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle4;/* '<S8>/GetAngle4' */
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle3;/* '<S8>/GetAngle3' */
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle2;/* '<S8>/GetAngle2' */
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle1;/* '<S8>/GetAngle1' */
  P_GetAngle_ZeroForceDrag_Doub_T GetAngle;/* '<S8>/GetAngle' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J6_BG;/* '<S18>/J6_BG' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J5_BG;/* '<S18>/J5_BG' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J4_BG;/* '<S18>/J4_BG' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J3_BG;/* '<S18>/J3_BG' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J2_BG;/* '<S18>/J2_BG' */
  P_J1_BG_ZeroForceDrag_DoubleJ_T J1_BG;/* '<S18>/J1_BG' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J6_TF;/* '<S19>/J6_TF' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J5_TF;/* '<S19>/J5_TF' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J4_TF;/* '<S19>/J4_TF' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J3_TF;/* '<S19>/J3_TF' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J2_TF;/* '<S19>/J2_TF' */
  P_J1_TF_ZeroForceDrag_DoubleJ_T J1_TF;/* '<S19>/J1_TF' */
};

/* Real-time Model Data Structure */
struct tag_RTM_ZeroForceDrag_DoubleJ_T {
  const char_T *errorStatus;
};

/* Block parameters (default storage) */
extern P_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_P;

/* Block signals (default storage) */
extern B_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_B;

/* Block states (default storage) */
extern DW_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_DW;
...
extern void ZeroForceDrag_DoubleJoints_initialize(void);
extern void ZeroForceDrag_DoubleJoints_step(void);
extern void ZeroForceDrag_DoubleJoints_terminate(void);

/* Real-time Model object */
extern RT_MODEL_ZeroForceDrag_Double_T *const ZeroForceDrag_DoubleJoints_M;
 ...
 *
 * '<Root>' : 'ZeroForceDrag_DoubleJoints'
 * '<S1>'   : 'ZeroForceDrag_DoubleJoints/DynamicCalculation'
 * '<S2>'   : 'ZeroForceDrag_DoubleJoints/SendDataToGUI'
 * '<S3>'   : 'ZeroForceDrag_DoubleJoints/Subsystem'
 * '<S4>'   : 'ZeroForceDrag_DoubleJoints/接收上位机的数据'
 * '<S5>'   : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息'
 * '<S6>'   : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/Compensate'
 * '<S7>'   : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor'
 * '<S8>'   : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity'
 * '<S9>'   : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver'
 * '<S10>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令'
 * '<S11>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint1'
 * '<S12>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint2'
 * '<S13>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint3'
 * '<S14>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint4'
 * '<S15>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint5'
 * '<S16>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/BottomDriver/Joint6'
 * '<S17>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2'
 * '<S18>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG'
 * '<S19>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF'
 * '<S20>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1'
 * '<S21>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/check'
 * '<S22>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/start_arm'
 * '<S23>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J1_BG'
 * '<S24>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J2_BG'
 * '<S25>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J3_BG'
 * '<S26>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J4_BG'
 * '<S27>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J5_BG'
 * '<S28>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/BG/J6_BG'
 * '<S29>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J1_TF'
 * '<S30>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J2_TF'
 * '<S31>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J3_TF'
 * '<S32>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J4_TF'
 * '<S33>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J5_TF'
 * '<S34>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/TF/J6_TF'
 * '<S35>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J1_UM1'
 * '<S36>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J2_UM1'
 * '<S37>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J3_UM1'
 * '<S38>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J4_UM1'
 * '<S39>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J5_UM1'
 * '<S40>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/UM1/J6_UM1'
 * '<S41>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/DriveMotor/驱动器指令/Chart2/start_arm/StartRobotSubsystem'
 * '<S42>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle'
 * '<S43>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1'
 * '<S44>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2'
 * '<S45>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3'
 * '<S46>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4'
 * '<S47>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5'
 * '<S48>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed'
 * '<S49>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1'
 * '<S50>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2'
 * '<S51>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3'
 * '<S52>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4'
 * '<S53>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5'
 * '<S54>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint1'
 * '<S55>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint2'
 * '<S56>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint3'
 * '<S57>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint4'
 * '<S58>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint5'
 * '<S59>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle/Joint6'
 * '<S60>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint1'
 * '<S61>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint2'
 * '<S62>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint3'
 * '<S63>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint4'
 * '<S64>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint5'
 * '<S65>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle1/Joint6'
 * '<S66>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint1'
 * '<S67>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint2'
 * '<S68>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint3'
 * '<S69>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint4'
 * '<S70>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint5'
 * '<S71>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle2/Joint6'
 * '<S72>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint1'
 * '<S73>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint2'
 * '<S74>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint3'
 * '<S75>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint4'
 * '<S76>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint5'
 * '<S77>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle3/Joint6'
 * '<S78>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint1'
 * '<S79>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint2'
 * '<S80>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint3'
 * '<S81>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint4'
 * '<S82>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint5'
 * '<S83>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle4/Joint6'
 * '<S84>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint1'
 * '<S85>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint2'
 * '<S86>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint3'
 * '<S87>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint4'
 * '<S88>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint5'
 * '<S89>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngle5/Joint6'
 * '<S90>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint1'
 * '<S91>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint2'
 * '<S92>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint3'
 * '<S93>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint4'
 * '<S94>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint5'
 * '<S95>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed/Joint6'
 * '<S96>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint1'
 * '<S97>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint2'
 * '<S98>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint3'
 * '<S99>'  : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint4'
 * '<S100>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint5'
 * '<S101>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed1/Joint6'
 * '<S102>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint1'
 * '<S103>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint2'
 * '<S104>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint3'
 * '<S105>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint4'
 * '<S106>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint5'
 * '<S107>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed2/Joint6'
 * '<S108>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint1'
 * '<S109>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint2'
 * '<S110>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint3'
 * '<S111>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint4'
 * '<S112>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint5'
 * '<S113>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed3/Joint6'
 * '<S114>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint1'
 * '<S115>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint2'
 * '<S116>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint3'
 * '<S117>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint4'
 * '<S118>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint5'
 * '<S119>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed4/Joint6'
 * '<S120>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint1'
 * '<S121>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint2'
 * '<S122>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint3'
 * '<S123>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint4'
 * '<S124>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint5'
 * '<S125>' : 'ZeroForceDrag_DoubleJoints/DynamicCalculation/GetAngleVelocity/GetAngleSpeed5/Joint6'
 * '<S126>' : 'ZeroForceDrag_DoubleJoints/SendDataToGUI/  '
 * '<S127>' : 'ZeroForceDrag_DoubleJoints/SendDataToGUI/广播周期'
 * '<S128>' : 'ZeroForceDrag_DoubleJoints/SendDataToGUI/广播周期/Increment Real World'
 * '<S129>' : 'ZeroForceDrag_DoubleJoints/SendDataToGUI/广播周期/Wrap To Zero'
 * '<S130>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/0x0080'
 * '<S131>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/0x88'
 * '<S132>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Compare To Constant1'
 * '<S133>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Compare To Constant2'
 * '<S134>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem'
 * '<S135>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/获取用户命令'
 * '<S136>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint1'
 * '<S137>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint2'
 * '<S138>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint3'
 * '<S139>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint4'
 * '<S140>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint5'
 * '<S141>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint6'
 * '<S142>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/Subsystem/Joint7'
 * '<S143>' : 'ZeroForceDrag_DoubleJoints/接收上位机的数据/获取用户命令/消息校验'
 * '<S144>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_284_24'
 * '<S145>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_285_25'
 * '<S146>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_286_26'
 * '<S147>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_281_21'
 * '<S148>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_282_22'
 * '<S149>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_283_23'
 * '<S150>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_284_24/Subsystem1'
 * '<S151>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_285_25/Subsystem'
 * '<S152>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANA_286_26/Subsystem'
 * '<S153>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_281_21/Subsystem'
 * '<S154>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_282_22/Subsystem'
 * '<S155>' : 'ZeroForceDrag_DoubleJoints/获取关节角度、角速度信息/CANB_283_23/Subsystem'
 */
#endif                                 /* RTW_HEADER_ZeroForceDrag_DoubleJoints_h_ */
