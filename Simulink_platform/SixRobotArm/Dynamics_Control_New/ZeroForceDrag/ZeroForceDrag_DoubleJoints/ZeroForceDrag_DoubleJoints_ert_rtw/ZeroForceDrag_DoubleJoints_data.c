/*
 * File: ZeroForceDrag_DoubleJoints_data.c
 *
...
P_ZeroForceDrag_DoubleJoints_T ZeroForceDrag_DoubleJoints_P = {
  ...
  /* Computed Parameter: Constant1_Value_np
  ...
  /* Computed Parameter: Constant3_Value_jx
  ...
  /* Computed Parameter: Constant_Value_bn
