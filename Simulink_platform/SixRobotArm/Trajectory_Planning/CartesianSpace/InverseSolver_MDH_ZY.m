function Theta =InverseSolver_MDH_ZY(Pos,LastAnlge)
%#codegen
...
%% L6=Link('d',67,'a',0,'alpha',-pi/2,'modified');
   ...
   T_goat=[  cos(beta)*cos(gama),-cos(beta)*sin(gama),sin(beta),X;
    ...
    if ForJudgment<-1e-6
        ...
        a = AllSloverTheta(1,:);b = AllSloverTheta(2,:);c = AllSloverTheta(3,:);d = AllSloverTheta(4,:);
        e = AllSloverTheta(5,:);f = AllSloverTheta(6,:);g = AllSloverTheta(7,:);h = AllSloverTheta(8,:);

        Zeros=[0,0,0,0,0,0];
        T=[a;b;c;d;e;f;g;h];
        if(isequal(Zeros,a)==0)
            u1=(a(1,1)-LastAnlge(1,1))^2+(a(1,2)-LastAnlge(1,2))^2+(a(1,3)-LastAnlge(1,3))^2+(a(1,4)-LastAnlge(1,4))^2+(a(1,5)-LastAnlge(1,5))^2+(a(1,6)-LastAnlge(1,6))^2;
        else
            u1=-1;
        end

        if(isequal(Zeros,b)==0)
            u2=(b(1,1)-LastAnlge(1,1))^2+(b(1,2)-LastAnlge(1,2))^2+(b(1,3)-LastAnlge(1,3))^2+(b(1,4)-LastAnlge(1,4))^2+(b(1,5)-LastAnlge(1,5))^2+(b(1,6)-LastAnlge(1,6))^2;
        else
            u2=-1;
        end

        if(isequal(Zeros,c)==0)
            u3=(c(1,1)-LastAnlge(1,1))^2+(c(1,2)-LastAnlge(1,2))^2+(c(1,3)-LastAnlge(1,3))^2+(c(1,4)-LastAnlge(1,4))^2+(c(1,5)-LastAnlge(1,5))^2+(c(1,6)-LastAnlge(1,6))^2;
        else
            u3=-1;
        end

        if(isequal(Zeros,d)==0)
            u4=(d(1,1)-LastAnlge(1,1))^2+(d(1,2)-LastAnlge(1,2))^2+(d(1,3)-LastAnlge(1,3))^2+(d(1,4)-LastAnlge(1,4))^2+(d(1,5)-LastAnlge(1,5))^2+(d(1,6)-LastAnlge(1,6))^2;
        else
            u4=-1;
        end

        if(isequal(Zeros,e)==0)
            u5=(e(1,1)-LastAnlge(1,1))^2+(e(1,2)-LastAnlge(1,2))^2+(e(1,3)-LastAnlge(1,3))^2+(e(1,4)-LastAnlge(1,4))^2+(e(1,5)-LastAnlge(1,5))^2+(e(1,6)-LastAnlge(1,6))^2;
        else
            u5=-1;
        end

        if(isequal(Zeros,f)==0)
            u6=(f(1,1)-LastAnlge(1,1))^2+(f(1,2)-LastAnlge(1,2))^2+(f(1,3)-LastAnlge(1,3))^2+(f(1,4)-LastAnlge(1,4))^2+(f(1,5)-LastAnlge(1,5))^2+(f(1,6)-LastAnlge(1,6))^2;
        else
            u6=-1;
        end

        if(isequal(Zeros,g)==0)
            u7=(g(1,1)-LastAnlge(1,1))^2+(g(1,2)-LastAnlge(1,2))^2+(g(1,3)-LastAnlge(1,3))^2+(g(1,4)-LastAnlge(1,4))^2+(g(1,5)-LastAnlge(1,5))^2+(g(1,6)-LastAnlge(1,6))^2;
        else
            u7=-1;
        end

        if(isequal(Zeros,h)==0)
            u8=(h(1,1)-LastAnlge(1,1))^2+(h(1,2)-LastAnlge(1,2))^2+(h(1,3)-LastAnlge(1,3))^2+(h(1,4)-LastAnlge(1,4))^2+(h(1,5)-LastAnlge(1,5))^2+(h(1,6)-LastAnlge(1,6))^2;
        else
            u8=-1;
        end
